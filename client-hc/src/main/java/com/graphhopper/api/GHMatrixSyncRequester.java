...
public class GHMatrixSyncRequester extends GHMatrixAbstractRequester {
    ...
    @Override
    public MatrixResponse route(GHMRequest ghRequest) throws GhMExce {
        ...
        try {
            ...
            return matrixResponse;
        } catch (IOException | RequesterExce ex) {
            throw new GhMExce((IOException) ex);
        }
    }

    public class GhMExce extends Exception {
        public GhMExce(IOException ex) {
        }
    }
}
