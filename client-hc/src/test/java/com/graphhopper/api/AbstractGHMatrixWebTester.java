...
public abstract class AbstractGHMatrixWebTester {
    ...
    @Test
    public void testReadingMatrixWithError() throws IOException, GHMatrixSyncRequester.GhMExce, GHMatrixBatchRequester.MatrixExce {
    ...
    @Test
    public void testReadingWeights() throws IOException, GHMatrixSyncRequester.GhMExce, GHMatrixBatchRequester.MatrixExce {
    ...
    @Test
    public void testReadingMatrixConnectionsNotFound_noFailFast() throws IOException, GHMatrixSyncRequester.GhMExce, GHMatrixBatchRequester.MatrixExce {
    ...
    @Test
    public void testReadingMatrixPointsNotFound_noFailFast() throws IOException, GHMatrixSyncRequester.GhMExce, GHMatrixBatchRequester.MatrixExce {
    ...
    private static void eassertone(MatrixResponse rsp) {
    ...
    @Test
    public void testReadingGoogleThrowsException() throws IOException, GHMatrixSyncRequester.GhMExce, GHMatrixBatchRequester.MatrixExce {
    ...
    @Test
    public void testReadingWeights_TimesAndDistances() throws IOException, GHMatrixSyncRequester.GhMExce, GHMatrixBatchRequester.MatrixExce {
