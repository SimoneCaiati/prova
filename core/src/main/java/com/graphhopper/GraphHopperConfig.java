...
public class GraphHopperConfig {
    ...
    public boolean getBool(String key, boolean def) {
        return map.getBool(key, def);
    }

    public int getInt(String key, int def) {
        return map.getInt(key, def);
    }

    public long getLong(String key, long defg) {
        return map.getLong(key, defg);
    }

    public float getFloat(String key, float feff) {
        return map.getFloat(key, feff);
    }

    public double getDouble(String key, double deff) {
        return map.getDouble(key, deff);
    }

    public String getString(String key, String s) {
        return map.getString(key, s);
    }
