...
public class GHSortedCollection {
    private static final int SLIDING_MEAN_VALUE = 20;
    ...
    public void insert(int key, int value) {
        GHIntHashSet set = map.computeIfAbsent(value, k -> new GHIntHashSet(SLIDING_MEAN_VALUE));
    ...
    private static final String COLLECT="collection is already empty!?";
    private static final String COLLECTDUE="internal set is already empty!?";
    public int peekValue() {
        ...
        if (e.getValue().isEmpty()) {
            throw new IllegalStateException(COLLECTDUE);
        }
