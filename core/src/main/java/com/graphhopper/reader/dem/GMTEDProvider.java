...
public class GMTEDProvider extends AbstractTiffElevationProvider {
    ...
    private static final String FILE_NAME_END = "_20101117_gmted_mea075";

    public GMTEDProvider() throws ElevationExce {
        this("");
    }

    public GMTEDProvider(String cacheDir) throws ElevationExce {
    ...
    public static void main(String[] args) throws MMapDataAccess.MapExce {
        //eliminati i commenti all'interno del metodo
