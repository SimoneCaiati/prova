...
public class RestrictionTagParser {
    ...
    public Result parseRestrictionTags(Map<String, Object> tags) throws OSMRestrictionException {
        ...
        List<String> exceptVehicles = tags.containsKey("except")
                //  there are also some occurrences of except=resident(s), destination or delivery
        ...
        if (restriction != null) {
            ...
            if (limitedRestrictions.isEmpty())
                metodo2(hasGiveWay);
            Set<String> restrictions = metodo4(tags, limitedRestrictions, exceptVehicles);
    ...
    private Set<String> metodo4(Map<String, Object> tags, List<String> limitedRestrictions, List<String> exceptVehicles) throws OSMRestrictionException {
    ...
    private static void metodo2(boolean hasGiveWay) throws OSMRestrictionException {
        if (!hasGiveWay)
    ...
    private static void metodo1(List<String> limitedRestrictions) throws OSMRestrictionException {
        if (!limitedRestrictions.isEmpty())
