...
public class ConditionalParser {
    ...
    public static ConditionalValueParser createNumberParser(final String assertKey, final Number obj) {
        return conditionalValue -> {
            ...
            ConditionalValueParser.ConditionState invalid = mimmo(assertKey, obj, conditionalValue, indexLT);
    ...
    private static ConditionalValueParser.ConditionState mimmo(String assertKey, Number obj, String conditionalValue, int indexLT) {
