...
public class SPTEntry implements Comparable<SPTEntry> {
    ...
    public boolean equals(Object o) {
        ...
        SPTEntry sptEntry = (SPTEntry) o;
        return edge == sptEntry.edge && adjNode == sptEntry.adjNode && Double.compare(sptEntry.weight, weight) == 0 && deleted == sptEntry.deleted && Objects.equals(parent, sptEntry.parent);
    }

    @Override
    public int hashCode() {
        return Objects.hash(edge, adjNode, weight, parent, deleted);
    }
