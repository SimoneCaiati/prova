...
public class ShortcutUnpacker {
    ...
    private void expandEdge(RoutingCHEdgeIteratorState edge, boolean reverse, int prevOrNextEdgeId) {
        ...
        if (edgeBased) {
            ...
            expandSkippedEdgesNodeBased(edge.getSkippedEdge1(), edge.getSkippedEdge2(), edge.getAdjNode(), reverse);
        }
    }
    ...
    private void expandSkippedEdgesNodeBased(int skippedEdge1, int skippedEdge2, int adj, boolean reverse) {
        RoutingCHEdgeIteratorState sk2 = getEdge(skippedEdge2, adj);
