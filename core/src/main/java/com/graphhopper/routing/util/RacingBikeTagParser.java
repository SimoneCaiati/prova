...
public class RacingBikeTagParser extends BikeCommonTagParser {
    private static final String RACING="racingbike";
    public RacingBikeTagParser(EncodedValueLookup lookup, PMap properties) {
        this(
                lookup.getBooleanEncodedValue(VehicleAccess.key(RACING)),
                lookup.getDecimalEncodedValue(VehicleSpeed.key(RACING)),
                lookup.getDecimalEncodedValue(VehiclePriority.key(RACING)),
                lookup.getEnumEncodedValue(BikeNetwork.KEY, RouteNetwork.class),
                lookup.getEnumEncodedValue(Smoothness.KEY, Smoothness.class),
                lookup.getBooleanEncodedValue(Roundabout.KEY),
                lookup.hasEncodedValue(TurnCost.key(RACING)) ? lookup.getDecimalEncodedValue(TurnCost.key(RACING)) : null
        );
    ...
    protected RacingBikeTagParser(BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc, DecimalEncodedValue priorityEnc,
        ...
        super(accessEnc, speedEnc, priorityEnc, bikeRouteEnc, smoothnessEnc, RACING, roundaboutEnc, turnCostEnc);
