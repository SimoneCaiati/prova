...
public class RoadDensityCalculator {
    ...
    public double calcRoadDensity(EdgeIteratorState edge, double radius, ToDoubleFunction<EdgeIteratorState> calcRoadFactor) {
        ...
        final double radiusNormalized = DistancePlaneProjection.getInstancePlane().calcNormalizedDist(radius);
        while (!deque.isEmpty()) {
            ...
            while (iter.next()) {
                ...
                double distance = DistancePlaneProjection.getInstancePlane().calcNormalizedDist(center.getLat(), center.getLon(), getLat(na, iter.getBaseNode(), iter.getAdjNode()), getLon(na, iter.getBaseNode(), iter.getAdjNode()));
