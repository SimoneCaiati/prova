...
public class OSMRoadAccessParser implements TagParser {
    ...
    private static final String CIAO ="access";
    private static final String CICCIO ="motor_vehicle";
    private static final String MIAMARTNI="vehicle";
    public static List<String> toOSMRestrictions(TransportationMode mode) {
        switch (mode) {
            case FOOT:
                return Arrays.asList("foot", CIAO);
            case VEHICLE:
                return Arrays.asList(MIAMARTNI, CIAO);
            case BIKE:
                return Arrays.asList("bicycle", MIAMARTNI, CIAO);
            case CAR:
                return Arrays.asList("motorcar", CICCIO, MIAMARTNI, CIAO);
            case MOTORCYCLE:
                return Arrays.asList("motorcycle", CICCIO, MIAMARTNI, CIAO);
            case HGV:
                return Arrays.asList("hgv", CICCIO, MIAMARTNI, CIAO);
            case PSV:
                return Arrays.asList("psv", CICCIO, MIAMARTNI, CIAO);
            default:
