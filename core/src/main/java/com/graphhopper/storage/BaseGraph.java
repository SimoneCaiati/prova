...
public class BaseGraph implements Graph, Closeable {
    ...
    public BaseGraph create(long initSize) throws MMapDataAccess.MappaExce {
        checkNotInitialized();
        dir.create();
     ...
     */
    public void flushAndCloseGeometryAndNameStorage() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce {
    ...
    private PointList fetchWayGeometry(long edgePointer, boolean reverse, FetchMode mode, int baseNode, int adjNode) {
        ...
        methodBase1(reverse, mode, baseNode, adjNode, pillarNodes);
    ...
    private void methodBase1(boolean reverse, FetchMode mode, int baseNode, int adjNode, PointList pillarNodes) {
        if (reverse) {
    ...
    public static class Builder {
        ...
        //  maybe rename later, but for now this makes it easier to replace GraphBuilder
        ...
        public BaseGraph create() throws MMapDataAccess.MappaExce {
    ...
    static class EdgeIteratorStateImpl implements EdgeIteratorState {
        ...
        public EdgeIteratorState setWayGeometry(PointList pillarNodes) {
            baseGraph.setwaygeometry(pillarNodes, edgePointer, reverse);
            return this;
        }

        @Override
        public PointList fetchWayGeometry(FetchMode mode) {
            return baseGraph.fetchWayGeometry(edgePointer, reverse, mode, getBaseNode(), getAdjNode());
        }
