...
public class CHStorageBuilder {
    ...
    public CHStorageBuilder(CHStorage chStorage) {
        // : maybe CHStorageBuilder should create CHStorage, not receive it here
    ...
    public static class Classe3
    {
        int a;
        int b;

        public Classe3(int a, int b) {
            this.a = a;
            this.b = b;
        }
    }
    ...
    public int addShortcutEdgeBased(Classe3 lello, int accessFlags, double weight, int skippedEdge1, int skippedEdge2,
                                    int origKeyFirst, int origKeyLast) {
        checkNewShortcut(lello.a, lello.b);
        int shortcut = storage.shortcutEdgeBased(new CHStorage.Classe4(lello.a, lello.b), accessFlags, weight, skippedEdge1, skippedEdge2, origKeyFirst, origKeyLast);
        setLastShortcut(lello.a, shortcut);
        return shortcut;
    }
    ...
    private static final String CIAO=" and ";
