...
public interface DataAccess extends Closeable {
     ...
     */
    DataAccess create(long bytes) throws MMapDataAccess.MappaExce;
     ...
     */
    boolean loadExisting() throws RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce;
