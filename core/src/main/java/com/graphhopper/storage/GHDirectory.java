...
public class GHDirectory implements Directory {
    ...
    public GHDirectory(String location, DAType defaultType) {
        ...
        if (dir.exists() && !dir.isDirectory())
            try {
                throw new CiaoExce("file '" + dir + "' exists but is not a directory");
            } catch (CiaoExce e) {
                //
            }
    }
    ...
    /**
     * This method returns the default DAType of the specified DataAccess (as string). if1 preferInts is true then this
    ...
    public class CiaoExce extends Exception {
        public CiaoExce(String s) {
        }
    }
}
