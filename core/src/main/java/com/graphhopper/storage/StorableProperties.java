...
public class StorableProperties {
    ...
    public synchronized boolean loadExisting() throws RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        if (!da.loadExisting())
            return false;
    ...
    public synchronized void flush() throws MMapDataAccess.MapExce, StorableExce {
        try {
            ...
            da.flush();
        } catch (IOException | RAMDataAccess.RamExce2 | RAMIntDataAccess.RamIntExce ex) {
            throw new StorableExce(ex);
        }
    }
    ...
    public synchronized StorableProperties create(long size) throws MMapDataAccess.MappaExce {
        da.create(size);
        return this;
    }
    ...
    public class StorableExce extends Exception {
        public StorableExce(Exception ex) {
        }
    }
}
