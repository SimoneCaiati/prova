...
public class Constants {
    ...
    private static final java.util.logging.Logger loggerSas = java.util.logging.Logger.getLogger(Constants.class.getName());
    /**
    ...
    static {
        ...
        if ("${project.version}".equals(version)) {
            VERSION = "0.0";
            SNAPSHOT = true;
            loggerSas.info("GraphHopper Initialization WARNING: maven did not preprocess the version file! Do not use the jar for a release!");
