...
public interface DistanceCalc {
     ...
     */
    double calcNormalizedEdgeDistance(double rlatdeg, double rlonleg,
    ...
    public class InnerCalc{
        public final double rlatdeg;
        public final double rlondeg;
        public final double relem;

        public InnerCalc(double rlatdeg, double rlondeg, double relem) {
            this.rlatdeg = rlatdeg;
            this.rlondeg = rlondeg;
            this.relem = relem;
        }
    }
    double calcNormalizedEdgeDistance3D(InnerCalc innercalc,
