...
public class MiniPerfTest {
     ...
     */
    public MiniPerfTest start(Task m) throws MeasurExce2, Task.MeasureExce3, MeasureExce {
    ...
    public interface Task {
         ...
         */
        int doCalc(boolean warmup, int run) throws MeasurExce2, MeasureExce3, MeasureExce;

        class MeasureExce3 extends Exception {
        }
    }
    ...
    public static class MeasureExce extends Exception {
    }
}
