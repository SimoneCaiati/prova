...
public class IntersectionDetails extends AbstractPathDetailsBuilder {
    ...
    private class IntersectionValues implements Comparable<IntersectionValues> {
        ...
        @Override
        public int compareTo(IntersectionValues other) {
            return Integer.compare(this.bearing, other.bearing);
        }
        ...
        public boolean equals(Object obj) {
            ...
            IntersectionValues other = (IntersectionValues) obj;
            return this.bearing == other.bearing;
        }

        @Override
        public int hashCode() {
            return Objects.hash(bearing, entry, in, out);
        }
    }
