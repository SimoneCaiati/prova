...
public class PathDetailsBuilderFactory {
    ...
    public List<PathDetailsBuilder> createPathDetailsBuilders(List<String> requestedPathDetails, EncodedValueLookup evl, Weighting weighting, Graph graph) {
        ...
        mollami(requestedPathDetails, weighting, builders);

        mollamidue(requestedPathDetails, weighting, builders);
    ...
    private static void mollamidue(List<String> requestedPathDetails, Weighting weighting, List<PathDetailsBuilder> builders) {
    ...
    private static void mollami(List<String> requestedPathDetails, Weighting weighting, List<PathDetailsBuilder> builders) {
