...
public class GraphHopperTest {
    ...
    @CsvSource({
     ...
     void testMonacoDifferentAlgorithms(String algo, boolean withCH, int expectedVisitedNodes) throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMonacoWithInstructions() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void withoutInstructions() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testUTurn() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "shortest";
        GraphHopper hopper = new GraphHopper().
    ...
    private void testImportCloseAndLoad(boolean ch, boolean lm, boolean sort, boolean custom) throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String vehicle = "foot";
        ...
        if (custom) {
            ...
            customModel.getPriority().add(Statement.if1("in_area51", Statement.Op.MULTIPLY, "0.1"));
    ...
    @Test
     void testImportThenLoadCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        testImportCloseAndLoad(true, false, false, false);
    }

    @Test
     void testImportThenLoadLM() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        testImportCloseAndLoad(false, true, false, false);
    }

    @Test
     void testImportThenLoadLMWithCustom() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        testImportCloseAndLoad(false, true, false, true);
    }

    @Test
     void testImportThenLoadCHLM() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        testImportCloseAndLoad(true, true, false, false);
    }

    @Test
     void testImportThenLoadCHLMAndSort() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        testImportCloseAndLoad(true, true, true, false);
    }

    @Test
     void testImportThenLoadFlexible() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        testImportCloseAndLoad(false, false, false, false);
    }

    @Test
     void testImportWithCHANDCustomProfile() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testAlternativeRoutes() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testAlternativeRoutesBike() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
    ...
    @Test
     void testAlternativeRoutesCar() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
    ...
    @Test
     void testPointHint() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
    ...
    @Test
     void testForwardBackwardDestination() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        GraphHopper hopper = new GraphHopper().
                setGraphHopperLocation(GH_LOCATION).
                setOSMFile(BAUTZEN).
    ...
    @Test
     void testNorthBayreuthAccessDestination() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
    ...
    @Test
     void testNorthBayreuthBlockedEdges() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
    ...
    private static void assErt(GHResponse rsp, int expected, int delta) {
        assertFalse(rsp.hasErrors(), rsp.getErrors().toString());
        assertEquals(expected, rsp.getBest().getDistance(), delta);
    }

    @Test
     void testCustomModel() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String vehicle = "car";
        final String customCar = "custom_car";
        final String emptyCar = "empty_car";
        CustomModel customModel = new CustomModel();
        customModel.addToSpeed(Statement.if1("road_class == TERTIARY || road_class == TRACK", Statement.Op.MULTIPLY, "0.1"));
        GraphHopper hopper = new GraphHopper().
                setGraphHopperLocation(GH_LOCATION).
                setOSMFile(BAYREUTH).
                setProfiles(
        ...
        CustomModel strictCustomModel = new CustomModel().addToSpeed(
                Statement.if1("road_class == TERTIARY || road_class == TRACK || road_class == UNCLASSIFIED", Statement.Op.MULTIPLY, "0.1"));
        ...
        CustomModel customModelWithUnclassifiedRule = new CustomModel().addToSpeed(
                Statement.if1("road_class == UNCLASSIFIED", Statement.Op.MULTIPLY, "0.1")
        );
    ...
    @Test
     void testMonacoVia() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
        GraphHopper hopper = new GraphHopper().
    ...
    private static void pollocicci(Translation tr, InstructionList il) {
    ...
    private static void polloessere(Translation tr, ResponsePath res) {
    ...
    private static void polloora(GHResponse rsp) {
        ResponsePath res;
        res = rsp.getBest();
        assertEquals(0, res.getDistance(), .1);
        assertEquals(0, res.getRouteWeight(), .1);
    ...
    @Test
     void testMonacoPathDetails() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testMonacoEnforcedDirection() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testMonacoMaxVisitedNodes() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testMonacoNonChMaxWaypointDistance() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testMonacoNonChMaxWaypointDistanceMultiplePoints() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testMonacoStraightVia() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testSRTMWithInstructions() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
    ...
    @ValueSource(booleans = {true, false})
     void testSRTMWithTunnelInterpolation(boolean withTunnelInterpolation) throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
        ...
        assertEquals(Snap.Position.TOWER, hopper.getLocationIndex().findClosest(from.getLat(), from.getLon(), EdgeFilter.ALL_EDGES).getSnappedPosition());
        assertEquals(Snap.Position.TOWER, hopper.getLocationIndex().findClosest(to.getLat(), to.getLon(), EdgeFilter.ALL_EDGES).getSnappedPosition());
    ...
    @Test
     void testSRTMWithLongEdgeSampling() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
    ...
    @Disabled("A caso")
    @Test
     void testSkadiElevationProvider() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
    ...
    @Test
     void testKremsCyclewayInstructionsWithWayTypeInfo() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testRoundaboutInstructionsWithCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testCircularJunctionInstructionsWithCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMultipleVehiclesWithCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testIfCHIsUsed() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    private void executeCHFootRoute(boolean sort) throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "shortest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testSortWhileImporting() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testRoundTour() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testPathDetails1216() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
    ...
    @Test
     void testPathDetailsSamePoint() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testFlexMode_631() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        ...
        assertNotEquals( "Visited nodes for hybrid mode should be different to CH but " + hSum + "==" + chSum,String.valueOf(hSum != chSum));
    ...
    @Test
     void testCrossQuery() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testLMConstraintsForCustomProfiles() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper().
                setGraphHopperLocation(GH_LOCATION).
                setOSMFile(MONACO).
                setProfiles(
    ...
    @Test
     void testCreateWeightingHintsMerging() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
    ...
    @Test
     void testPreparedProfileNotAvailable() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testDisablingLM() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @ParameterizedTest
    @ValueSource(booleans = {true, false})
     void testCompareAlgos(boolean turnCosts) throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @ParameterizedTest
    @ValueSource(booleans = {true, false})
     void testAStarCHBug(boolean turnCosts) throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "car";
        final String vehicle = "car";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testIssue1960() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "car";
        final String vehicle = "car";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testTurnCostsOnOff() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testTurnCostsOnOffCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testCHOnOffWithTurnCosts() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testNodeBasedCHOnlyButTurnCostForNonCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testEncoderWithTurnCostSupport_stillAllows_nodeBasedRouting() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        // see #1698
        final String profile = "profile";
        final String vehicle = "foot";
        final String weighting = "fastest";
    ...
    @Test
     void testOneWaySubnetwork_issue1807() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testEdgeCount() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper().
                setGraphHopperLocation(GH_LOCATION).
                setOSMFile(BAYREUTH).
                setMinNetworkSize(50).
    ...
    @Test
     void testCurbsides() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testForceCurbsides() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testCHWithFiniteUTurnCosts() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper h = new GraphHopper().
                setGraphHopperLocation(GH_LOCATION).
                setOSMFile(MONACO).
    ...
    @Test
     void simplifyWithInstructionsAndPathDetails() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        GraphHopper hopper = new GraphHopper();
    ...
    private void assErt2(InstructionList instructions) {
    ...
    @Test
     void testNoLoad() throws TranslationMap.TransExce {
        ...
        try {
            hopper.route(new GHRequest(42, 10.4, 42, 10).setProfile(profile));
    ...
    @Test
     void connectionNotFound() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
        GraphHopper hopper = new GraphHopper().
    ...
    @Test
     void testDoNotInterpolateTwice1645() throws lockexception, closefile, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, StorableProperties.StorableExce, TranslationMap.TransExce {
        ...
        assertEquals(1, counter.get());
        {
            ...
            try {
                hopper.load();
            } catch (GraphHopper.LockOffException | RAMDataAccess.RamExce | MMapDataAccess.MappaExce |
                     LMPreparationHandler.LMExce e) {
                //nothing
            }
        }
        assertEquals(1, counter.get());
    ...
    @Test
     void issue2306_1() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        GraphHopper hopper = new GraphHopper().
                setGraphHopperLocation(GH_LOCATION).
    ...
    @Test
     void issue2306_2() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testBarriers() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper().
                setGraphHopperLocation(GH_LOCATION).
                setOSMFile("../map-matching/files/leipzig_germany.osm.pbf").
                setProfiles(
    ...
    @Test
     void germanyCountryRuleAvoidsTracks() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
    ...
    @Test
    void curbsideWithSubnetwork_issue2502() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        GraphHopper hopper = new GraphHopper()
    ...
    @Test
    void averageSpeedPathDetailBug() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        GraphHopper hopper = new GraphHopper()
    ...
    @Test
    void timeDetailBug() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        final String profile = "profile";
        GraphHopper hopper = new GraphHopper()
                .setProfiles(new Profile(profile).setVehicle("car").setWeighting("fastest").setTurnCosts(true).putHint(U_TURN_COSTS, 80))
                .setGraphHopperLocation(GH_LOCATION)
    ...
    @Test
     void testLoadGraph_implicitEncodedValues_issue1862() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper()
                .setProfiles(
    ...
    @Test
    void testLoadingWithAnotherSpeedFactorWorks() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        {
            GraphHopper hopper = new GraphHopper()
