 ...
 */
 class GHTreeMapComposedTest {
    ...
    @Test
     void testDifferentValuesSameKey() {
    ...
    @Test
     void testDifferentKeysSameValue() {
        instance.insert(0, -4.0f);
    ...
    @Test
     void testUpdateDuplicateValues() {
        instance.insert(34302, 26.25f);
    ...
    @Test
     void testRemovingNonExistentKeyThrows() {
