...
import static org.junit.jupiter.api.Assertions.assertEquals;
 ...
 class QuadEdgeSubdivisionTest {

    @Test
     void testJtsDelaunayTriangulator() {
    ...
    @Test
     void createQuadEdgeSubdivisionFromScratch() throws ContourBuilder.CounterExce {
        Vertex v1 = new Vertex(0.0, 0.0, 0.0);
        Vertex v2 = new Vertex(1.0, -1.0, 1.0);
        Vertex v3 = new Vertex(1.0, 1.0, 0.0);
        Vertex v4 = new Vertex(2.0, 0.0, 0.0);
    ...
    @Test
     void createQuadEdgeSubdivisionFromTriangleList() throws Triangulation.TrianExce, ContourBuilder.CounterExce {
    ...
    @Test
     void createQuadEdgeSubdivisionFromTriangleList2() throws Triangulation.TrianExce, ContourBuilder.CounterExce {
        Triangulation triangulation = new Triangulation();
