...
public class ShortestPathTreeTest {
    ...
    @Test
     void testSPTAndIsochrone25Seconds() {
    ...
    @Test
     void testEdgeBasedWithFreeUTurns() {
        List<ShortestPathTree.IsoLabel> result = new ArrayList<>();
    ...
    @Test
     void testEdgeBasedWithForbiddenUTurns() {
    ...
    @Test
     void testEdgeBasedWithFinitePositiveUTurnCost() {
    ...
    @Test
     void testEdgeBasedWithSmallerUTurnCost() {
