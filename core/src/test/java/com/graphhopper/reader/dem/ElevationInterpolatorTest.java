 ...
 */
 class ElevationInterpolatorTest {
    ...
    @Test
     void calculatesElevationOnTwoPoints() {
        assertEquals(15, elevationInterpolator.calculateElevationBasedOnTwoPoints(new ElevationInterpolator.InnerElevation(0, 0), -10, -10,
                10, 10, 10, 20), PRECISION);
        assertEquals(15, elevationInterpolator.calculateElevationBasedOnTwoPoints(new ElevationInterpolator.InnerElevation(-10, 10), -10, -10,
                10, 10, 10, 20), PRECISION);
        assertEquals(15, elevationInterpolator.calculateElevationBasedOnTwoPoints(new ElevationInterpolator.InnerElevation(-5, 5), -10, -10,
                10, 10, 10, 20), PRECISION);
        assertEquals(19, elevationInterpolator.calculateElevationBasedOnTwoPoints(new ElevationInterpolator.InnerElevation(8, 8), -10, -10,
                10, 10, 10, 20), PRECISION);
        assertEquals(10, elevationInterpolator.calculateElevationBasedOnTwoPoints(new ElevationInterpolator.InnerElevation(0, 0),
                -ElevationInterpolator.EPSILON / 3, 0, 10,
                ElevationInterpolator.EPSILON / 2, 0, 20), PRECISION);
        assertEquals(20, elevationInterpolator.calculateElevationBasedOnTwoPoints(new ElevationInterpolator.InnerElevation(0, 0),
                -ElevationInterpolator.EPSILON / 2, 0, 10,
                ElevationInterpolator.EPSILON / 3, 0, 20), PRECISION);
        assertEquals(10, elevationInterpolator.calculateElevationBasedOnTwoPoints(new ElevationInterpolator.InnerElevation(0, 0), 0, 0, 10, 0,
                0, 20), PRECISION);
    }

    @Test
     void calculatesElevationOnThreePoints() {
        assertEquals(-0.88, elevationInterpolator.calculateElevationBasedOnThreePoints(new ElevationInterpolator.InnerCalculate(0, 0, 1,
                2, 3), 4, 6, 9, 12, 11, 9), PRECISION);
        assertEquals(15, elevationInterpolator.calculateElevationBasedOnThreePoints(new ElevationInterpolator.InnerCalculate(10, 0, 0, 0, 0),
                10, 10, 10, 10, -10, 20), PRECISION);
        assertEquals(5, elevationInterpolator.calculateElevationBasedOnThreePoints(new ElevationInterpolator.InnerCalculate(5, 5, 0, 0, 0),
                10, 10, 10, 20, 20, 20), PRECISION);
    }

    @Test
     void calculatesElevationOnNPoints() {
