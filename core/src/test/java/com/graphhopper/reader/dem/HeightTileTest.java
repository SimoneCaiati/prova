 ...
 */
 class HeightTileTest {
    @Test
     void testGetHeight() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testGetHeightForNegativeTile() throws MMapDataAccess.MappaExce {
        int width = 10;
    ...
    @Test
     void testInterpolate() throws MMapDataAccess.MappaExce {
