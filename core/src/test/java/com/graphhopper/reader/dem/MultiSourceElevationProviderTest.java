 ...
 * @author Robin Boldt
 */
 class MultiSourceElevationProviderTest {
    ...
    @Test
     void testGetEleMocked() throws threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
