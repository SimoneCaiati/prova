...
/**
 * @author Peter Karich
 */ class SRTMProviderTest {
    private double precision = .1;
    SRTMProvider instance;

    @BeforeEach
    public void setUp() throws TileBasedElevationProvider.ElevationExce {
    ...
    @Test
     void testGetHeight() throws IOException, threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
...
//        instance.getEle(43, 13);
    ...
    @Test
     void testGetHeight_issue545() throws IOException, threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
        instance = new SRTMProvider("./files/");
    ...
    @Test
     void testGetHeightMMap() throws IOException, threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
        instance = new SRTMProvider("./files/");
        assertEquals(161, instance.getEle(55.8943144, -3), 1e-1);
    }
    ...
    @Disabled("boh")
    @Test
     void testGetEle() throws threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
        instance = new SRTMProvider();
    ...
    @Disabled("boh")
    @Test
     void testGetEleVerticalBorder() throws threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
        instance = new SRTMProvider();
    ...
    @Disabled("boh")
    @Test
     void testGetEleHorizontalBorder() throws threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
        instance = new SRTMProvider();
    ...
    @Disabled("boh")
    @Test
     void testDownloadIssue_1274() throws threadException, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TileBasedElevationProvider.ElevationExce {
        instance = new SRTMProvider();
