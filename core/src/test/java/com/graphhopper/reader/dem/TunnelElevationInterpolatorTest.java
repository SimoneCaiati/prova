 ...
 */
 class TunnelElevationInterpolatorTest extends EdgeElevationInterpolatorTest {
    ...
    @Test
     void doesNotInterpolateElevationOfTunnelWithZeroOuterNodes() {
    ...
    @Test
     void interpolatesElevationOfTunnelWithSingleOuterNode() {
    ...
    @Test
     void interpolatesElevationOfTunnelWithTwoOuterNodes() {
    ...
    @Test
     void interpolatesElevationOfTunnelWithThreeOuterNodes() {
    ...
    @Test
     void interpolatesElevationOfTunnelWithFourOuterNodes() {
