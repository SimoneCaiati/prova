 ...
 */
 class GraphHopperOSMTest {
    ...
    @Test
     void testLoadOSM() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testLoadOSMNoCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testQueryLocationIndexWithBBox() throws lockexception, TranslationMap.TransExce {
    ...
    @Test
     void testLoadingWithDifferentCHConfig_issue471_pr1488() throws lockexception, TranslationMap.TransExce {
        ...
        try {
            gh.load();
        } catch (closefile | MMapDataAccess.MapExce | GraphHopper.LockOffException | RAMDataAccess.RamExce |
                 RAMDataAccess.RamExce2 | RAMIntDataAccess.RamIntExce | MMapDataAccess.MappaExce |
    ...
    @Test
     void testAllowMultipleReadingInstances() throws lockexception, TranslationMap.TransExce {
        String vehicle = "car";
    ...
    @Test
     void testDoNotAllowWritingAndLoadingAtTheSameTime() throws Exception {
        ...
        } catch (GraphHopper.LockOffException ex) {
            assertNotNull(ex);
    ...
    @Test
     void testPrepare() throws lockexception, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
    ...
    @Test
     void testSortedGraph_noCH() throws lockexception, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
        instance = new GraphHopper().
    ...
    @Test
     void testFootAndCar() throws lockexception, TranslationMap.TransExce {
    ...
    @Test
     void testNothingHappensWhenFlagEncodersAreChangedForLoad() throws lockexception, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        ...
        try {
            instance.load();
                 ...
                 RAMDataAccess.RamExce2 | RAMIntDataAccess.RamIntExce | MMapDataAccess.MappaExce |
                 LMPreparationHandler.LMExce ex) {
            //nothing
        }
        assertEquals(5, instance.getBaseGraph().getNodes());
    ...
    @Test
     void testFailsForWrongEVConfig() throws lockexception, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        instance = new GraphHopper().init(
                        new GraphHopperConfig().
                                putObject("datareader.file", testOsm3).
                                putObject("datareader.dataaccess", "RAM").
        ...
        try {
            instance.load();
        } catch (closefile | GraphHopper.LockOffException | RAMDataAccess.RamExce | MMapDataAccess.MappaExce |
                 LMPreparationHandler.LMExce e) {
            //nothing
        }
        assertEquals(5, instance.getBaseGraph().getNodes());
    ...
    @Test
     void testNoNPE_ifLoadNotSuccessful() throws TranslationMap.TransExce {
        ...
        try {
            ...
            try {
                assertFalse(instance.load());
                     ...
                     RAMDataAccess.RamExce2 | RAMIntDataAccess.RamIntExce e) {
                //nothing
            }
            instance.route(new GHRequest(10, 40, 12, 32).setProfile(profile));
            fail();
        } catch (IllegalStateException | lockexception | MMapDataAccess.MappaExce | LMPreparationHandler.LMExce ex) {
            assertEquals("Do a successful call to load or importOrLoad before routing", ex.getMessage());
        }
    }

    @Test
     void testDoesNotCreateEmptyFolderIfLoadingFromNonExistingPath() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        instance = new GraphHopper();
    ...
    @Test
     void testFailsForMissingParameters() throws TranslationMap.TransExce {
    ...
    @Test
     void testFootOnly() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testVia() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        final String profile = "profile";
        final String vehicle = "car";
        final String weighting = "fastest";
    ...
    @Test
     void testMultipleCHPreparationsInParallel() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMultipleLMPreparationsInParallel() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testGetMultipleWeightingsForCH() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper().
                setProfiles(
    ...
    @Test
     void testProfilesMustNotBeChanged() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        {
    ...
    private GraphHopper createHopperWithProfiles(List<Profile> profiles) throws TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper();
    ...
    @Test
     void testLoadingLMAndCHProfiles() throws lockexception, closefile, MMapDataAccess.MapExce, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, StorableProperties.StorableExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper()
                .setGraphHopperLocation(ghLoc)
                .setOSMFile(testOsm)
                .setProfiles(new Profile("car").setVehicle("car").setWeighting("fastest"));
