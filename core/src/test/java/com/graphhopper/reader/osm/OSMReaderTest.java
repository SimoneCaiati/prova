...
class OSMReaderTest {
    ...
    @Test
    void testMain() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    private static void mollyone(int n10, EdgeIterator iter) {
        assertTrue(iter.next());
        assertEquals("route 666", iter.getName());
    ...
    private void olemail(GraphHopper hopper, NodeAccess na) {
    ...
    private static void moccat(int n20, EdgeIterator iter) {
        assertTrue(iter.next());
        assertEquals("route 666", iter.getName());
    ...
    private void badliar(EdgeIterator iter) {
        assertTrue(iter.get(carAccessEnc));
        assertTrue(iter.getReverse(carAccessEnc));
    ...
    @Test
    void testSort() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
    void testOneWay() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    private void assErt3(int n23, EdgeIterator iter) {
        assertTrue(iter.next());
    ...
    @Test
    void testFerry() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopperFacade(file2) {
            @Override
            public void cleanUp() {
            }
    ...
    @Test
    void testMaxSpeed() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopperFacade(file2) {
            @Override
            public void cleanUp() {
            }
    ...
    @Test
     void testWayReferencesNotExistingAdjNode_issue19() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testDoNotRejectEdgeIfFirstNodeIsMissing_issue2221() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void test_edgeDistanceWhenFirstNodeIsMissing_issue2221() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testFoot() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testNegativeIds() throws MMapDataAccess.MapExce {
        String fileNegIds = "test-osm-negative-ids.xml";
        try {
            GraphHopperFacade facade = new GraphHopperFacade(fileNegIds);
            facade.importOrLoad();
        } catch (MMapDataAccess.MapExce | lockexception | closefile | TranslationMap.TransExce e) {
            assertTrue(e.getCause().getMessage().contains("Invalid OSM NODE Id: -10;"));
        }
    ...
    @Test
     void testBarrierBetweenWays() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testFords() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void avoidsLoopEdges_1525() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    void checkLoop(GraphHopper hopper) {
        ...
        while (iter.next()) {
            assertNotEquals( "found a loop",String.valueOf(iter.getAdjNode() != iter.getBaseNode()));
        }
    ...
    @Test
     void avoidsLoopEdgesIdenticalLatLon_1533() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        checkLoop(new GraphHopperFacade("test-avoid-loops2.xml").importOrLoad());
    }

    @Test
     void avoidsLoopEdgesIdenticalNodeIds_1533() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        // BDCBB
    ...
    @Test
     void testBarriersOnTowerNodes() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopperFacade(fileBarriers).
                setMinNetworkSize(0).
                importOrLoad();
        Graph graph = hopper.getBaseGraph();
    ...
    @Test
     void testTurnRestrictionsFromXML() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        ...
        assertTrue(tcStorage.get(carTCEnc, edge2_3, n3, edge3_8) > 0);
        assertEquals(0,tcStorage.get(carTCEnc, edge2_3, n3, edge3_4));
        assertEquals(0,tcStorage.get(carTCEnc, edge2_3, n3, edge3_2));
        assertEquals(0,tcStorage.get(carTCEnc, edge2_3, n3, edge3_4));
        assertEquals(0,tcStorage.get(carTCEnc, edge4_3, n3, edge3_2));
        assertEquals(0, tcStorage.get(carTCEnc, edge8_3, n3, edge3_2));

        // u-turn restriction for (6-1)->(1-6) but not for (1-6)->(6-1)
        assertTrue(tcStorage.get(carTCEnc, edge1_6, n1, edge1_6) > 0);
        assertEquals(0, tcStorage.get(carTCEnc, edge1_6, n6, edge1_6));
        ...
        assertEquals(0, tcStorage.get(carTCEnc, edge4_5, n5, edge5_6));
        ...
        assertEquals(0, tcStorage.get(bikeTCEnc, edge4_5, n5, edge5_6));
        ...
        assertEquals(0, tcStorage.get(carTCEnc, edge11_14, n11, edge10_11));
        assertEquals(0, tcStorage.get(bikeTCEnc, edge11_14, n11, edge10_11));
    ...
    @Test
     void testRoadAttributes() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testReadEleFromDataProvider() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
     ...
     */
    @Test
     void testTurnFlagCombination() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper();
    ...
    @Test
     void testConditionalTurnRestriction() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMultipleTurnRestrictions() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testPreferredLanguage() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testDataDateWithinPBF() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testCrossBoundary_issue667() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        ...
        assertEquals(0.1, snap.getSnappedPoint().getLat(), 0.1);
        assertEquals(179.5, snap.getSnappedPoint().getLon(), 0.1);
        ...
        assertTrue(snap.isValid());
        assertEquals(0.1, snap.getSnappedPoint().getLat(), 0.1);
        assertEquals(-179.6, snap.getSnappedPoint().getLon(), 0.1);
        assertEquals(112, snap.getClosestEdge().getDistance() / 1000, 1);
    }

    @Test
     void testRoadClassInfo() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testCountries() throws IOException, MMapDataAccess.MappaExce, MMapDataAccess.MapExce {
    ...
    @Test
     void testCurvedWayAlongBorder() throws IOException, MMapDataAccess.MappaExce, MMapDataAccess.MapExce {
    ...
    class GraphHopperFacade extends GraphHopper {
        public GraphHopperFacade(String osmFile) throws TranslationMap.TransExce {
            this(osmFile, false, "");
        }

        public GraphHopperFacade(String osmFile, boolean turnCosts, String prefLang) throws TranslationMap.TransExce {
            super();
