...
class WayToEdgeConverterTest {
    ...
    @Test
    void convertForViaWays() throws OSMRestrictionException, MMapDataAccess.MappaExce {
    ...
    @Test
    void convertForViaWays_throwsIfViaWayIsSplitIntoMultipleEdges() throws MMapDataAccess.MappaExce {
        BaseGraph graph = new BaseGraph.Builder(1).create();
        graph.edge(0, 1);
        graph.edge(1, 2);
        graph.edge(2, 3);
