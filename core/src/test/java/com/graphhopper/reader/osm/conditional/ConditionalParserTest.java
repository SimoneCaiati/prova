 ...
 * @author Robin Boldt
 */
 class ConditionalParserTest extends CalendarBasedTest {
    ...
    private static void lunatre(ConditionalParser instance) throws ParseException {
    ...
    private static void lunadue(ConditionalParser instance) throws ParseException {
        instance.setConditionalValueParser(ConditionalParser.createNumberParser("weight", 10));
        assertFalse(instance.checkCondition("no @weight>10"));
        instance.setConditionalValueParser(ConditionalParser.createNumberParser("weight", 9));
        assertFalse(instance.checkCondition("no @weight>10"));
    ...
    private static void luna() throws ParseException {
