 ...
 * @author Robin Boldt
 */
 class DateRangeParserTest extends CalendarBasedTest {
    final DateRangeParser dateRangeParser = new DateRangeParser();

    @Test
     void testParseConditional() throws ParseException {
    ...
    @Test
     void testParseSimpleDateRange() throws ParseException {
    ...
    @Test
     void testParseSimpleDateRangeWithoutYear() throws ParseException {
    ...
    @Test
     void testParseSimpleDateRangeWithoutYearAndDay() throws ParseException {
    ...
    @Test
     void testParseSimpleDateRangeWithoutYearAndDay2() throws ParseException {
    ...
    @Test
     void testParseReverseDateRange() throws ParseException {
    ...
    @Test
     void testParseReverseDateRangeWithoutYear() throws ParseException {
    ...
    @Test
     void testParseReverseDateRangeWithoutYearAndDay() throws ParseException {
    ...
    @Test
     void testParseReverseDateRangeWithoutYearAndDay_645() throws ParseException {
    ...
    @Test
     void testParseSingleDateRange() throws ParseException {
    ...
    @Test
     void testParseSingleDateRangeWithoutDay() throws ParseException {
    ...
    @Test
     void testParseSingleDateRangeWithoutYearAndDay() throws ParseException {
    ...
    @Test
     void testParseSingleDateRangeOneDayOnly() throws ParseException {
    ...
    @Test
     void testParseSingleDateRangeOneDayOnlyIncludingPh() throws ParseException {
    ...
    @Test
     void testParseSingleDateRangeDayOnly() throws ParseException {
    ...
    @Test
     void testParseReverseDateRangeDayOnly() throws ParseException {
        // This is reverse since Su=7 and Mo=1 
        // Note: if1 we use Locale.Germany or Locale.UK for calendar creation
    ...
    private void assertSameDate(int year, int month, int day, String dateString) throws ParseException {
        ...
        Calendar actual = actualParsed.cave;
