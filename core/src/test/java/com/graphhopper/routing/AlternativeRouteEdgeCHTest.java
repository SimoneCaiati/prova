...
import static org.junit.jupiter.api.Assertions.assertTrue;
 ...
 class AlternativeRouteEdgeCHTest {
    ...
    public BaseGraph createTestGraph(EncodingManager tmpEM) throws MMapDataAccess.MappaExce {
    ...
    private RoutingCHGraph prepareCH(BaseGraph graph) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testAssumptions() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testCalcAlternatives() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        BaseGraph g = createTestGraph(em);
        PMap hints = new PMap();
    ...
    @Test
     void testCalcOtherAlternatives() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        BaseGraph g = createTestGraph(em);
        PMap hints = new PMap();
        hints.putObject("alternative_route.max_weight_factor", 4);
        hints.putObject("alternative_route.local_optimality_factor", 0.5);
