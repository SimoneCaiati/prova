...
public class AlternativeRouteTest {
    ...
    private static final class Fixture {
        ...
        public Fixture(TraversalMode tMode) throws MMapDataAccess.MappaExce {
    ...
    @ArgumentsSource(FixtureProvider.class)
     void testCalcAlternatives(Fixture f) {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCalcAlternatives2(Fixture f) {
        initTestGraph(f.graph, f.accessEnc, f.speedEnc);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testDisconnectedAreas(Fixture f) {
        initTestGraph(f.graph, f.accessEnc, f.speedEnc);
