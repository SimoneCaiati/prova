 ...
 * @author easbar
 */
 class DefaultBidirPathExtractorTest {
    ...
    BaseGraph createGraph() throws MMapDataAccess.MappaExce {
        return new BaseGraph.Builder(encodingManager).withTurnCosts(true).create();
    }

    @Test
     void testExtract() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testExtract2() throws MMapDataAccess.MappaExce {
        // 1->2->3
        Graph graph = createGraph();
