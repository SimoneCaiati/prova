 ...
 */
 class DijkstraBidirectionCHTest {
    ...
    @Test
     void testBaseGraph() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testBaseGraphMultipleVehicles() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    // 4----------3--/
    @Test
     void testStallingNodesReducesNumberOfVisitedNodes() throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
    ...
    //      \--<---|
    @Test
     void testDirectionDependentSpeedFwdSearch() throws MMapDataAccess.MappaExce {
    ...
    //      \--<---|
    @Test
     void testDirectionDependentSpeedBwdSearch() throws MMapDataAccess.MappaExce {
    ...
    private void runTestWithDirectionDependentEdgeSpeed(double speed, double revSpeed, int from, int to, IntArrayList expectedPath, BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc) throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
    ...
    private RoutingCHGraph prepareCH(BaseGraph graph, CHConfig chConfig) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        graph.freeze();
