 ...
 */
 class DijkstraOneToManyTest {
    ...
    @Test
     void testIssue182() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testIssue239_and362() throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
        GHUtility.setSpeed(60, 60, accessEnc, speedEnc,
                graph.edge(0, 1).setDistance(1),
                graph.edge(1, 2).setDistance(1),
    ...
    @Test
     void testUseCache() throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
    ...
    @Test
     void testWeightLimit_issue380() throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
    ...
    @Test
     void testUseCacheZeroPath_issue707() throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
        initTestStorage(graph, accessEnc, speedEnc);
        RoutingAlgorithm algo = createAlgo(graph);
