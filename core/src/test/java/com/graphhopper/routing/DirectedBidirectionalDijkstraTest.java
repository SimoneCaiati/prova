 ...
 */
 class DirectedBidirectionalDijkstraTest {
    ...
    @Test
     void notConnectedDueToRestrictions() {
        //   - 1 -
        //  /     \
        // 0       2
        //  \     /
    ...
    @Test
     void forcingDirectionDoesNotMeanWeCannotUseEdgeAtAll() {
        // 0 - 6 - 7
        // |
        // 1
        // |
    ...
    @Test
     void sourceAndTargetAreNeighbors() {
        // 0-1-2-3
    ...
    @RepeatedTest(10)
     void compare_standard_dijkstra() {
        compare_with_dijkstra(weighting);
    }

    @RepeatedTest(10)
     void compare_standard_dijkstra_finite_uturn_costs() {
    ...
    private void compare_with_dijkstra(Weighting w) {
        ...
        int numNodes = 100;
        GHUtility.buildRandomGraph(new GHUtility.Salmo(graph, rnd, numNodes, 2.2, true, true),
    ...
    @Test
     void directedRouting_noUTurnAtVirtualEdge() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
