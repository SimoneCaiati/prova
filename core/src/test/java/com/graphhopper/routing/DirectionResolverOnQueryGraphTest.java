 ...
 */
 class DirectionResolverOnQueryGraphTest {
    ...
    @Test
    void junction() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //      3
        //    a | b
        // 0 -> 1 -> 2
        //    c | d
    ...
    @Test
     void multiple_locations_same_road() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //      3     5
        //  0 --x--x--x-- 1
        //         4
        addNode(0, 1, 1);
    ...
    @Test
     void multiple_locations_same_road_one_way() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //      3     5
        //  0 --x--x--x--> 1
        //         4
        addNode(0, 1, 1);
    ...
    @Test
     void two_locations_same_spot_same_side() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //      3
        //      3
        //  0 --x-- 1
        addNode(0, 1, 1);
    ...
    @Test
     void two_locations_same_spot_different_sides() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //      3
        //  0 --x-- 1
        //      3
        addNode(0, 1, 1);
    ...
    @Test
     void road_with_geometry() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //       3
        //    x --- x
        //   3|  3  |3
        //    0     1
    ...
    @Test
     void sharp_curves() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 0 --- x
        //      /
        //     x---- 1
        addNode(0, 2, 1);
    ...
    @Test
     void junction_hitFromTheSide() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 0  1  2
        //  \ | /
        //   \|/
        //    3
    ...
    @Test
     void duplicateCoordinatesAtBaseOrAdjNode() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 0-x   x-1
        //   x-x-x
        addNode(0, 0, 0);
        addNode(1, 1, 1);
    ...
    @Test
     void closeToTowerNode_issue2443() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 0x-1
    ...
    @Test
     void unblockedBarrierEdge_issue2443() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 0---1-2
    ...
    private void init() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
