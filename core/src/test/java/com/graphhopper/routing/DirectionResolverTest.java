 ...
 */
 class DirectionResolverTest {
    ...
    @Test
     void isolated_nodes_blocked_edge() {
        // 0 |-| 1
        addNode(0, 0, 0);
        addNode(1, 0.1, 0.1);
    ...
    @Test
     void isolated_nodes_with_loops() {
        // 1      2__     3    4     5-6
        // |\     |  \    |\   |\      |\
        // x-x    x->x    --   ->      --
        addNode(0, 2, 0);
    ...
    @Test
     void nodes_at_end_of_dead_end_street() {
        //       4
        //       |
        // 0 --> 1 --> 2
        //       |
    ...
    @Test
     void nodes_with_loops() {
        ...
        // if1 there is a loop there is often no reasonable way to restrict the direction similar to junctions.
        // 0------1-------2----3
        // |\     |  \    |\   |\
        // x-x    x->x    --   ->
        addNode(0, 2, 0);
