...
class HeadingRoutingTest {
    ...
    @Test
     void headingTest1() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
    ...
    @Test
     void headingTest2() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
    ...
    @Test
     void headingTest3() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
        BooleanEncodedValue accessEnc = VehicleAccess.create("car");
        DecimalEncodedValue speedEnc = VehicleSpeed.create("car", 5, 5, false);
        EncodingManager encodingManager = new EncodingManager.Builder().add(accessEnc).add(speedEnc).add(Subnetwork.create("profile")).build();
        BaseGraph graph = createSquareGraph(encodingManager, accessEnc, speedEnc);
    ...
    @Test
     void headingTest4() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
    ...
    @Test
     void headingTest5() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
    ...
    @Test
     void testHeadingWithSnapFilter() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
        BooleanEncodedValue accessEnc = VehicleAccess.create("car");
        DecimalEncodedValue speedEnc = VehicleSpeed.create("car", 5, 5, false);
        EncodingManager encodingManager = new EncodingManager.Builder().add(accessEnc).add(speedEnc).add(Subnetwork.create("profile")).build();
    ...
    @Test
     void testHeadingWithSnapFilter2() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
        BooleanEncodedValue accessEnc = VehicleAccess.create("car");
        DecimalEncodedValue speedEnc = VehicleSpeed.create("car", 5, 5, false);
        EncodingManager encodingManager = new EncodingManager.Builder().add(accessEnc).add(speedEnc).add(Subnetwork.create("profile")).build();
        BaseGraph graph = createSquareGraphWithTunnel(encodingManager, accessEnc, speedEnc);
    ...
    @Test
     void headingTest6() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
    ...
    private Router createRouter(BaseGraph graph, EncodingManager encodingManager) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce, TranslationMap.TransExce {
        ...
        return new Router(new GraphHopper.InnerRouter(graph.getBaseGraph(), encodingManager, locationIndex, profilesByName), new PathDetailsBuilderFactory(), new TranslationMap().doImport(), new RouterConfig(),
                new DefaultWeightingFactory(graph.getBaseGraph(), encodingManager), Collections.emptyMap(), Collections.emptyMap());
    }

    private BaseGraph createSquareGraph(EncodingManager encodingManager, BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc) throws MMapDataAccess.MappaExce {
    ...
    private BaseGraph createSquareGraphWithTunnel(EncodingManager encodingManager, BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc) throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(encodingManager).create();
        // 2----3---4
        // |    |   |
