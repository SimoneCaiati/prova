...
@SuppressWarnings("java:S5976")
 class PathTest {
    ...
    public PathTest() throws MMapDataAccess.MappaExce {
    }

    @Test
     void testFound() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testWayList() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
        ...
        asserzioniMethod(tmp);

        tmp = instr.get(1);
        asserzioniMethod2(tmp);
    ...
    private void asserzioniMethod2(Instruction tmp) {
    ...
    private void asserzioniMethod(Instruction tmp) {
    ...
    @Test
     void testFindInstruction() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
        NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testCalcInstructionsRoundaboutBegin() {
    ...
    @Test
     void testCalcInstructionsRoundaboutDirectExit() {
    ...
    @Test
     void testCalcAverageSpeedDetails() {
    ...
    @Test
     void testCalcStreetNameDetails() {
        ShortestWeighting weighting = new ShortestWeighting(carAccessEnc, carAvSpeedEnc);
        Path p = new Dijkstra(pathDetailGraph, weighting, TraversalMode.NODE_BASED).calcPath(1, 5);
        assertTrue(p.isFound());
    ...
    @Test
     void testCalcEdgeKeyDetailsForward() {
        ShortestWeighting weighting = new ShortestWeighting(carAccessEnc, carAvSpeedEnc);
        Path p = new Dijkstra(pathDetailGraph, weighting, TraversalMode.NODE_BASED).calcPath(1, 5);
        assertTrue(p.isFound());
    ...
    @Test
     void testCalcEdgeKeyDetailsBackward() {
        ShortestWeighting weighting = new ShortestWeighting(carAccessEnc, carAvSpeedEnc);
    ...
    @Test
     void testCalcIntersectionDetails() {
        ShortestWeighting weighting = new ShortestWeighting(carAccessEnc, carAvSpeedEnc);
        Path p = new Dijkstra(pathDetailGraph, weighting, TraversalMode.NODE_BASED).calcPath(1, 5);
        assertTrue(p.isFound());
     ...
     */
    @Test
     void testCalcInstructionsRoundabout2() {
    ...
    @Test
     void testCalcInstructionsRoundaboutIssue353() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testCalcInstructionsIgnoreContinue() {
    ...
    @Test
     void testCalcInstructionsIgnoreTurnIfNoAlternative() {
    ...
    @Test
     void testCalcInstructionForForkWithSameName() throws MMapDataAccess.MappaExce {
        final BaseGraph graph = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = graph.getNodeAccess();
    ...
    @Test
     void testCalcInstructionForMotorwayFork() throws MMapDataAccess.MappaExce {
        final BaseGraph graph = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = graph.getNodeAccess();
    ...
    @Test
     void testCalcInstructionsEnterMotorway() throws MMapDataAccess.MappaExce {
        final BaseGraph graph = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = graph.getNodeAccess();
    ...
    @Test
     void testCalcInstructionsMotorwayJunction() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testCalcInstructionsOntoOneway() throws MMapDataAccess.MappaExce {
        final BaseGraph g = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testCalcInstructionIssue1047() throws MMapDataAccess.MappaExce {
        final BaseGraph g = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testCalcInstructionContinueLeavingStreet() throws MMapDataAccess.MappaExce {
        final BaseGraph g = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testCalcInstructionSlightTurn() throws MMapDataAccess.MappaExce {
        final BaseGraph g = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testUTurnLeft() throws MMapDataAccess.MappaExce {
        final BaseGraph g = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testUTurnRight() throws MMapDataAccess.MappaExce {
        final BaseGraph g = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testCalcInstructionsForTurn() {
        // The street turns left, but there is not turn
        ShortestWeighting weighting = new ShortestWeighting(mixedCarAccessEnc, mixedCarSpeedEnc);
        Path p = new Dijkstra(roundaboutGraph.g, weighting, TraversalMode.NODE_BASED)
                .calcPath(11, 13);
    ...
    @Test
     void testCalcInstructionsForSlightTurnWithOtherSlightTurn() {
    ...
    @Test
     void testCalcInstructionsForSlightTurnOntoDifferentStreet() throws MMapDataAccess.MappaExce {
        final BaseGraph g = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = g.getNodeAccess();
    ...
    @Test
     void testIgnoreInstructionsForSlightTurnWithOtherTurn() {
    ...
    private Graph generatePathDetailsGraph() throws MMapDataAccess.MappaExce {
        final BaseGraph graph = new BaseGraph.Builder(carManager).create();
        final NodeAccess na = graph.getNodeAccess();
    ...
    private class RoundaboutGraph {
        ...
        private RoundaboutGraph() throws MMapDataAccess.MappaExce {
