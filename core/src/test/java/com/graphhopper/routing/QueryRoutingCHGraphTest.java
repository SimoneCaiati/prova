...
class QueryRoutingCHGraphTest {
    ...
    @Test
     void basic() throws MMapDataAccess.MappaExce {
        // 0-1-2
    ...
    @Test
     void withShortcuts() throws MMapDataAccess.MappaExce {
        // 0-1-2
        //  \-/
        GHUtility.setSpeed(60, true, true, accessEnc, speedEnc, graph.edge(0, 1).setDistance(10));
        GHUtility.setSpeed(60, true, true, accessEnc, speedEnc, graph.edge(1, 2).setDistance(10));
        ...
        chBuilder.addShortcutEdgeBased(new CHStorageBuilder.Classe3(0, 2), PrepareEncoder.getScFwdDir(), 20, 0, 1, 0, 2);
...
//        assertNodesConnected(queryCHGraph, 0, 2, false);
    ...
    @Test
     void withVirtualEdges() throws MMapDataAccess.MappaExce {
        //  2 3
        // 0-x-1-2
        //   3
        ...
        snap.calcSnappedPoint(DistancePlaneProjection.getInstancePlane());
    ...
    @Test
     void withVirtualEdgesAndShortcuts() throws MMapDataAccess.MappaExce {
        //  /---\
        // 0-x-1-2
        //   3
        na.setNode(0, 50.00, 10.00);
...
//        assertNodesConnected(queryCHGraph, 0, 2, false);
    ...
    @Test
     void getBaseGraph() throws MMapDataAccess.MappaExce {
        GHUtility.setSpeed(60, true, true, accessEnc, speedEnc, graph.edge(0, 1).setDistance(10));
        graph.freeze();
    ...
    @Test
     void getEdgeIteratorState() throws MMapDataAccess.MappaExce {
        //  /---\
        // 0-x-1-2
        //   3
        na.setNode(0, 50.00, 10.00);
    ...
    @Test
     void getWeighting() throws MMapDataAccess.MappaExce {
        graph.freeze();
        QueryGraph queryGraph = QueryGraph.create(graph, Collections.<Snap>emptyList());
    ...
    @Test
     void getLevel() throws MMapDataAccess.MappaExce {
        // 0-x-1
        na.setNode(0, 50.00, 10.00);
        na.setNode(1, 50.00, 10.10);
        EdgeIteratorState edge = addEdge(graph, 0, 1);
    ...
    @Test
     void getWeight() throws MMapDataAccess.MappaExce {
        //  /---\
        // 0-x-1-2
        //   3
        na.setNode(0, 50.00, 10.00);
        ...
        chBuilder.setIdentityLevels();
        chBuilder.addShortcutEdgeBased(new CHStorageBuilder.Classe3(0, 2), PrepareEncoder.getScDirMask(), 20, 0, 1, 0, 2);

        // without query graph
        RoutingCHEdgeIterator iter = routingCHGraph.createOutEdgeExplorer().setBaseNode(0);
        asserzioniMethod2(routingCHGraph, iter);
        ...
        asserzioniMetgod3(iter, queryCHGraph);
    ...
    private void asserzioniMetgod3(RoutingCHEdgeIterator iter, QueryRoutingCHGraph queryCHGraph) {
        assertNextEdge(iter, 0, 3, 2);
        assertEquals(142.9494, iter.getWeight(false), 1.e-4);
        assertEquals(428.8483, iter.getWeight(true), 1.e-4);
        assertNextShortcut(iter, 0, 2, 0, 1);
    ...
    private void asserzioniMethod2(RoutingCHGraph routingCHGraph, RoutingCHEdgeIterator iter) {
        assertNextShortcut(iter, 0, 2, 0, 1);
        assertEquals(20, iter.getWeight(false), 1.e-6);
        assertEquals(20, iter.getWeight(true), 1.e-6);
    ...
    @Test
     void getWeight_withAccess() throws MMapDataAccess.MappaExce {
        na.setNode(0, 50.00, 10.00);
        na.setNode(1, 50.00, 10.10);
        double dist = DistancePlaneProjection.getInstancePlane().calcDist(na.getLat(0), na.getLon(0), na.getLat(1), na.getLon(1));
        ...
        // 0->1
        RoutingCHEdgeIterator iter = routingCHGraph.createOutEdgeExplorer().setBaseNode(0);
        asserzioniMethod1(routingCHGraph, iter);
    ...
    private void asserzioniMethod1(RoutingCHGraph routingCHGraph, RoutingCHEdgeIterator iter) {
        assertNextEdge(iter, 0, 1, 0);
        assertEquals(428.8483, iter.getWeight(false), 1.e-4);
        assertEquals(Double.POSITIVE_INFINITY, iter.getWeight(true));
        assertEnd(iter);
    ...
    @Test
     void getTurnCost() throws MMapDataAccess.MappaExce {
        //  /-----\
        // 0-x-1-x-2
        //   3   4
        na.setNode(0, 50.00, 10.00);
        ...
        snap1.calcSnappedPoint(DistancePlaneProjection.getInstancePlane());

        Snap snap2 = new Snap(50.00, 10.15);
        snap2.setClosestEdge(edge2);
        snap2.setWayIndex(0);
        snap2.setSnappedPosition(Snap.Position.EDGE);
        snap2.calcSnappedPoint(DistancePlaneProjection.getInstancePlane());
    ...
    private EdgeIteratorState addEdge(Graph graph, int from, int to) {
        ...
        double dist = DistancePlaneProjection.getInstancePlane().calcDist(na.getLat(from), na.getLon(from), na.getLat(to), na.getLon(to));
