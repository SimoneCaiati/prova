 ...
 */
 class RoundTripRoutingTest {
    ...
    @Test
     void lookup_throwsIfNumberOfPointsNotOne() {
    ...
    @Test
     void testLookupAndCalcPaths_simpleSquareGraph() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testCalcRoundTrip() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    private BaseGraph createTestGraph() throws MMapDataAccess.MappaExce {
    ...
    private BaseGraph createSquareGraph() throws MMapDataAccess.MappaExce {
        // simple square
        //  1 | 0 1 2      
        //  0 | 7   3
        // -1 | 6 5 4 
