...
public class RoutingAlgorithmTest {
    ...
    private static class Fixture {
         ...
         */
        private BaseGraph createGHStorage() throws MMapDataAccess.MappaExce {
         ...
         */
        private BaseGraph createGHStorage(boolean is3D) throws MMapDataAccess.MappaExce {
        ...
        private Path calcPath(BaseGraph graph, GHPoint from, GHPoint to) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
            return calcPath(graph, defaultWeighting, from, to);
        }

        private Path calcPath(BaseGraph graph, Weighting weighting, GHPoint from, GHPoint to) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        ...
        private void compareWithRef(Weighting weighting, BaseGraph graph, PathCalculator refCalculator, GHPoint from, GHPoint to, long seed) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @ArgumentsSource(FixtureProvider.class)
     void testCalcShortestPath(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCalcShortestPath_sourceEqualsTarget(Fixture f) throws MMapDataAccess.MappaExce {
        // 0-1-2
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testSimpleAlternative(Fixture f) throws MMapDataAccess.MappaExce {
        // 0--2--1
        //    |  |
        //    3--4
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testBidirectionalLinear(Fixture f) throws MMapDataAccess.MappaExce {
        //3--2--1--4--5
        BaseGraph graph = f.createGHStorage();
        GHUtility.setSpeed(60, true, true, f.carAccessEnc, f.carSpeedEnc, graph.edge(2, 1).setDistance(2));
        GHUtility.setSpeed(60, true, true, f.carAccessEnc, f.carSpeedEnc, graph.edge(2, 3).setDistance(11));
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCalcFastestPath(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCalcFootPath(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testNoPathFound(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        graph.edge(100, 101);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testWikipediaShortestPath(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCalcIf1EdgeAway(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        initTestStorage(graph, f.carAccessEnc, f.carSpeedEnc);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testBidirectional(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCreateAlgoTwice(Fixture f) throws MMapDataAccess.MappaExce {
        // 0-1-2-3-4
        // |     / |
        // |    8  |
        // \   /   /
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testMaxVisitedNodes(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        initBiGraph(graph, f.carAccessEnc, f.carSpeedEnc);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testBidirectional2(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testRekeyBugOfIntBinHeap(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCannotCalculateSP(Fixture f) throws MMapDataAccess.MappaExce {
        // 0->1->2
        BaseGraph graph = f.createGHStorage();
        GHUtility.setSpeed(60, true, false, f.carAccessEnc, f.carSpeedEnc, graph.edge(0, 1).setDistance(1));
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testDirectedGraphBug1(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testDirectedGraphBug2(Fixture f) throws MMapDataAccess.MappaExce {
        // 0->1->2
        //    | /
        //    3<
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testWithCoordinates(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testCalcIfEmptyWay(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        initTestStorage(graph, f.carAccessEnc, f.carSpeedEnc);
        Path p = f.calcPath(graph, 0, 0);
        assertPathFromEqualsTo(p, 0);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testViaEdges_FromEqualsTo(Fixture f) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        initTestStorage(graph, f.carAccessEnc, f.carSpeedEnc);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testViaEdges_BiGraph(Fixture f) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        initBiGraph(graph, f.carAccessEnc, f.carSpeedEnc);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testViaEdges_WithCoordinates(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        initTestStorage(graph, f.carAccessEnc, f.carSpeedEnc);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testViaEdges_SpecialCases(Fixture f) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
        // 0->1\
        // |    2
        // 4<-3/
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testQueryGraphAndFastest(Fixture f) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testTwoWeightsPerEdge(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void test0SpeedButUnblocked_Issue242(Fixture f) throws MMapDataAccess.MappaExce {
        BaseGraph graph = f.createGHStorage();
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testTwoWeightsPerEdge2(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testRandomGraph(Fixture f) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        ...
        GHUtility.buildRandomGraph(new GHUtility.Salmo(graph, rnd, 10, 2.0, false, true),
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testMultipleVehicles_issue548(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    private interface PathCalculator {
        ...
        Path calcPath(BaseGraph graph, Weighting weighting, TraversalMode traversalMode, int maxVisitedNodes, GHPoint from, GHPoint to) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce;
    ...
    private static abstract class SimpleCalculator implements PathCalculator {
        ...
        @Override
        public Path calcPath(BaseGraph graph, Weighting weighting, TraversalMode traversalMode, int maxVisitedNodes, GHPoint from, GHPoint to) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    private static abstract class CHCalculator implements PathCalculator {
        ...
        public Path calcPath(BaseGraph graph, Weighting weighting, TraversalMode traversalMode, int maxVisitedNodes, int from, int to) {
            ...
            RoutingCHGraph routingCHGraph = routingCHGraphs.computeIfAbsent(chGraphName, name -> {
                ...
                PrepareContractionHierarchies pch = null;
                try {
                    pch = PrepareContractionHierarchies.fromGraph(graph, chConfig);
                } catch (MMapDataAccess.MappaExce e) {
                    //
                }
                PrepareContractionHierarchies.Result res = null;
                try {
                    res = pch.doWork();
