 ...
 */
 class RoutingAlgorithmWithOSMTest {
    ...
    @Test
     void testMonaco() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMonacoMotorcycle() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testMonacoMotorcycleCurvature() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
        ...
        queries.add(new Query(43.730949, 7.412338, 43.739643, 7.424542, 2253, 120));
        queries.add(new Query(43.727592, 7.419333, 43.727712, 7.419333, 0, 1));
        CustomModel model = new CustomModel().addToPriority(Statement.if1("true", MULTIPLY, "curvature"));
    ...
    @Test
     void testBike2_issue432() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
...
//        list.add(new OneRun(52.349713, 8.013293, 52.349969, 8.013813, 293, 21));
    ...
    @Test
     void testOneWayCircleBug() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMoscow() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMoscowTurnCosts() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testSimpleTurnCosts() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testSimplePTurn() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> list = new ArrayList<>();
    ...
    @Test
     void testSidewalkNo() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testMonacoFastest() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMonacoMixed() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testMonacoFoot() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = createHopper(MONACO,
                new Profile("foot").setVehicle("foot").setWeighting("shortest"));
        hopper.importOrLoad();
    ...
    @Test
     void testMonacoFoot3D() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
    ...
    @Test
     void testNorthBayreuthHikeFastestAnd3D() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testMonacoBike3D() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
        ...
        CustomModel model = new CustomModel();
        model.addToSpeed(Statement.if1("average_slope >= 10", LIMIT, "4")).
                addToSpeed(Statement.if1("average_slope >= 5", MULTIPLY, "0.45")).
                addToSpeed(Statement.if1("average_slope >= 3.5", MULTIPLY, "0.7")).
                addToSpeed(Statement.if1("average_slope >= 2", MULTIPLY, "0.9")).
                addToSpeed(Statement.if1("average_slope < -5", MULTIPLY, "1.25"));
    ...
    @Test
     void testLandmarkBug() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
        Query run = new Query();
    ...
    @Test
     void testBug1014() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testMonacoBike() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testMonacoMountainBike() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testMonacoRacingBike() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
        queries.add(new Query(43.730864, 7.420771, 43.727687, 7.418737, 2594, 111));
    ...
    @Test
     void testKremsBikeRelation() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testKremsMountainBikeRelation() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testAndorra() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testAndorraPbf() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        Profile profile = new Profile("car").setVehicle("car").setWeighting("shortest");
    ...
    @Test
     void testAndorraFoot() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testCampoGrande() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
    ...
    @Test
     void testHarsdorf() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        List<Query> queries = new ArrayList<>();
    ...
    @Test
     void testNeudrossenfeld() throws lockexception, closefile, MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
        List<Query> list = new ArrayList<>();
    ...
    @Test
     void testDisconnectedAreaAndMultiplePoints() throws lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        Query query = new Query();
    ...
    @Test
     void testMonacoParallel() throws InterruptedException, lockexception, closefile, MMapDataAccess.MapExce, TranslationMap.TransExce {
        GraphHopper hopper = createHopper(MONACO, new Profile("car").setVehicle("car").setWeighting("shortest"));
     ...
     */
    private GraphHopper createHopper(String osmFile, Profile... profiles) throws TranslationMap.TransExce {
