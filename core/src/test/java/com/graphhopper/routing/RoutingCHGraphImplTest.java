...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class RoutingCHGraphImplTest {
    @Test
     void testBaseAndCHEdges() throws MMapDataAccess.MappaExce {
    ...
    @Test
    void testShortcutConnection() throws MMapDataAccess.MappaExce {
        //   4 ------ 1 > 0
        //            ^ \
        //            3  2
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
    ...
    @Test
     void testGetWeight() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph graph = new BaseGraph.Builder(em).create();
    ...
    @Test
     void testGetWeightIfAdvancedEncoder() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
    ...
    @Test
     void testWeightExact() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph graph = new BaseGraph.Builder(em).create();
    ...
    @Test
     void testSimpleShortcutCreationAndTraversal() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph graph = new BaseGraph.Builder(em).create();
    ...
    @Test
     void testAddShortcutSkippedEdgesWriteRead() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph graph = new BaseGraph.Builder(em).create();
    ...
    @Test
     void testSkippedEdges() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph graph = new BaseGraph.Builder(em).create();
    ...
    @Test
     void testAddShortcut_edgeBased_throwsIfNotConfiguredForEdgeBased() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph graph = new BaseGraph.Builder(em).create();
       ...
       try {
          chBuilder.addShortcutEdgeBased(new CHStorageBuilder.Classe3(0, 2), PrepareEncoder.getScFwdDir(), 10, 0, 1, 0, 2);
    ...
    @Test
     void testAddShortcut_edgeBased() throws MMapDataAccess.MappaExce {
        // 0 -> 1 -> 2
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
    ...
    @Test
     void testGetEdgeIterator() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph graph = new BaseGraph.Builder(em).set3D(true).create();
