...
@Disabled("for performance testing only")
 class TrafficChangeWithNodeOrderingReusingTest {
    ...
    private static class Fixture {
        ...
        public Fixture(int maxDeviationPercentage) throws MMapDataAccess.MappaExce {
    ...
    @ArgumentsSource(FixtureProvider.class)
     void testPerformanceForRandomTrafficChange(Fixture f) throws IOException, PrepareContractionHierarchies.PrepareExce, MiniPerfTest.MeasurExce2, MiniPerfTest.Task.MeasureExce3, MiniPerfTest.MeasureExce, MMapDataAccess.MappaExce, MMapDataAccess.MapExce {
    ...
    private static void runPerformanceTest(final BaseGraph graph, CHStorage chStorage, CHConfig chConfig, long seed, final int iterations) throws MiniPerfTest.MeasurExce2, MiniPerfTest.Task.MeasureExce3, MiniPerfTest.MeasureExce {
