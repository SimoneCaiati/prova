 ...
 */
 class CHTurnCostTest {
    ...
    @RepeatedTest(10)
     void testFindPath_randomContractionOrder_linear() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 2-1-0-3-4
    ...
    @Test
     void testFindPath_randomContractionOrder_duplicate_edges() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //  /\    /<-3
        // 0  1--2
        //  \/    \->4
    ...
    @Test
     void testFindPath_randomContractionOrder_double_duplicate_edges() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //  /\ /\   
        // 0  1  2--3
        //  \/ \/
    ...
    @RepeatedTest(100)
     void testFindPath_multipleInOutEdges_turnReplacementDifference() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //   0   3 - 4   8
        //    \ /     \ /
        // 1 - 5 - 6 - 7 - 9
        //    /         \
        ...
        // if1 this test fails use the logger output to generate code for further debugging.
    ...
    @Test
     void testFindPath_multipleInOutEdges_turnReplacementDifference_bug1() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //       3 - 4
        //      /     \
        // 1 - 5 - 6 - 7 - 9
        //    /         \
    ...
    @Test
     void testFindPath_duplicateEdge() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 0 -> 1 -> 2 -> 3 -> 4
        //            \->/
    ...
    @Test
     void testFindPath_chain() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 0   2   4   6   8
        //  \ / \ / \ / \ /
        //   1   3   5   7
        GHUtility.setSpeed(60, true, false, accessEnc, speedEnc, graph.edge(0, 1).setDistance(1));
    ...
    @Test
     void testFindPath_bidir_chain() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @RepeatedTest(10)
     void testFindPath_randomContractionOrder_simpleLoop() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //      2
        //     /|
        //  0-4-3
        //    |
    ...
    @RepeatedTest(10)
     void testFindPath_randomContractionOrder_singleDirectedLoop() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //  3 1-2
        //  | | |
        //  7-5-0
        //    |
    ...
    @RepeatedTest(10)
     void testFindPath_randomContractionOrder_singleLoop() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //  0   4
        //  |  /|
        //  1-2-3
        //    |
    ...
    @RepeatedTest(10)
     void testFindPath_randomContractionOrder_singleLoopWithNoise() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @RepeatedTest(10)
     void testFindPath_randomContractionOrder_complicatedGraphAndPath() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindPath_pTurn_uTurnAtContractedNode() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindPath_pTurn_uTurnAtContractedNode_twoShortcutsInAndOut() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //           2- 3
        //           |  |
        //           4- 0
        //           |
    ...
    @RepeatedTest(10)
     void testFindPath_highlyConnectedGraph_compareWithDijkstra() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        ...
        // if1 a test fails use the debug output to generate the graph creation code for further debugging!
    ...
    @Test
     void testFindPath_bug() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindPath_bug2() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 1 = 0 - 3 - 2 - 4
    ...
    @Test
     void testFindPath_loop() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //             3
        //            / \
        //           1   2
        //            \ /
    ...
    @Test
     void testFindPath_finiteUTurnCost() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindPath_calcTurnCostTime() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindPath_loopsMustAlwaysBeAccepted() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //     ---
        //     \ /
        // 0 -- 1 -- 2 -- 3
        EdgeIteratorState edge0 = GHUtility.setSpeed(60, true, true, accessEnc, speedEnc, graph.edge(0, 1).setDistance(1));
    ...
    @Test
     void testFindPath_compareWithDijkstra_zeroWeightLoops_random() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindPath_compareWithDijkstra_zeroWeightLoops() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //                  /|
        // 0 -> 1 -> 2 -> 3 --
        //                | \|
        //                4
    ...
    @Test
    void anotherDoubleZeroWeightLoop() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindPath_compareWithDijkstra_zeroWeightLoops_withTurnRestriction() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //                  /|
        // 0 -> 1 -> 2 -> 3 --
        //                | \|
        //                4
    ...
    @Test
     void testFindPath_oneWayLoop() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //     o
        // 0-1-2-3-4
        GHUtility.setSpeed(60, true, false, accessEnc, speedEnc, graph.edge(0, 1).setDistance(1));
        GHUtility.setSpeed(60, true, false, accessEnc, speedEnc, graph.edge(1, 2).setDistance(1));
    ...
    @Test
     void testFindPath_loopEdge() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 1-0
        // | |
        // 4-2o
    ...
    @ValueSource(strings = {DIJKSTRA_BI, ASTAR_BI})
     void test_issue1593_full(String algo) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //      6   5
        //   1<-x-4-x-3
        //  ||    |
        //  |x7   x8
    ...
    @ParameterizedTest
    @ValueSource(strings = {DIJKSTRA_BI, ASTAR_BI})
     void test_issue_1593_simple(String algo) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 1
        // |
        // 3-0-x-5-4
        // |
    ...
    @ParameterizedTest
    @ValueSource(strings = {DIJKSTRA_BI, ASTAR_BI})
     void testRouteViaVirtualNode(String algo) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //   3
        // 0-x-1-2
        ...
        assertEquals(DistancePlaneProjection.getInstancePlane().calcDist(0.00, 0.00, 0.03, 0.03), path.getDistance(), 1.e-1);
    }

    @ParameterizedTest
    @ValueSource(strings = {DIJKSTRA_BI, ASTAR_BI})
     void testRouteViaVirtualNode_withAlternative(String algo) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //   3
        // 0-x-1
        //  \  |
        //   \-2
    ...
    @ParameterizedTest
    @ValueSource(strings = {DIJKSTRA_BI, ASTAR_BI})
     void testFiniteUTurnCost_virtualViaNode(String algo) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        ...
        Snap snap = index.findClosest(virtualPoint.getLat(), virtualPoint.getLon(), EdgeFilter.ALL_EDGES);
        ...
        Snap snap2 = index.findClosest(virtualPoint.getLat(), virtualPoint.getLon(), EdgeFilter.ALL_EDGES);
    ...
    @ParameterizedTest
    @ValueSource(strings = {DIJKSTRA_BI, ASTAR_BI})
     void test_astar_issue2061(String algo) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
    void testZeroUTurnCosts_atBarrier_issue2564() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // lvl: 0 3 2 4 5 1
        //  nd: 0-1-2-3-4-5
    ...
    @Test
    void testBestFwdBwdEntryUpdate() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 2-3
        // | |
        // 0-4-1
    ...
    @Test
    void testEdgeKeyBug() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 1 - 2 - 0 - 4
        //          \ /
        //           3
     ...
     */
    @RepeatedTest(10)
     void testFindPath_random_compareWithDijkstra() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        long seed = System.nanoTime();
    ...
    @RepeatedTest(10)
     void testFindPath_random_compareWithDijkstra_finiteUTurnCost() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        long seed = System.nanoTime();
    ...
    @RepeatedTest(10)
     void testFindPath_random_compareWithDijkstra_zeroUTurnCost() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        long seed = System.nanoTime();
    ...
    private void compareWithDijkstraOnRandomGraph(long seed) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        final Random rnd = new Random(seed);
        // for larger graphs preparation takes much longer the higher the degree is!
        GHUtility.buildRandomGraph(new GHUtility.Salmo(graph, rnd, 20, 3.0, true, true),
     ...
     */
    @RepeatedTest(10)
     void testFindPath_heuristic_compareWithDijkstra() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        long seed = System.nanoTime();
    ...
    @RepeatedTest(10)
     void testFindPath_heuristic_compareWithDijkstra_finiteUTurnCost() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        long seed = System.nanoTime();
    ...
    private void compareWithDijkstraOnRandomGraph_heuristic(long seed) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        GHUtility.buildRandomGraph(new GHUtility.Salmo(graph, new Random(seed), 20, 3.0, true, true),
                accessEnc, speedEnc, null, 0.7, 0.9, 0.8);
        GHUtility.addRandomTurnCosts(graph, seed, accessEnc, turnCostEnc, maxCost, turnCostStorage);
        graph.freeze();
        checkStrict = false;
    ...
    private void checkPathUsingRandomContractionOrder(IntArrayList expectedPath, int expectedWeight, int expectedTurnCosts, int from, int to) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    private void checkPath(IntArrayList expectedPath, int expectedEdgeWeight, int expectedTurnCosts, int from, int to, int[] contractionOrder) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    private void checkPathUsingCH(IntArrayList expectedPath, int expectedEdgeWeight, int expectedTurnCosts, int from, int to, int[] contractionOrder) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    private Path findPathUsingCH(int from, int to, int[] contractionOrder) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        prepareCH(contractionOrder);
        RoutingAlgorithm chAlgo = createAlgo();
        return chAlgo.calcPath(from, to);
    }

    private void prepareCH(int... contractionOrder) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    private void automaticPrepareCH() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        PMap pMap = new PMap();
    ...
    private void automaticCompareCHWithDijkstra(int numQueries) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        long seed = System.nanoTime();
    ...
    private void compareCHWithDijkstra(int numQueries, int[] contractionOrder) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        long seed = System.nanoTime();
        LOGGER.info("Seed used to create random routing queries: {}", seed);
        final Random rnd = new Random(seed);
        prepareCH(contractionOrder);
