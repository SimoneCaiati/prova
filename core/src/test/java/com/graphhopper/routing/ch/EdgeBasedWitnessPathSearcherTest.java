...
import static org.junit.jupiter.api.Assertions.assertTrue;
 ...
 class EdgeBasedWitnessPathSearcherTest {

    @Test
     void test_shortcut_needed_basic() {
        // 0 -> 1 -> 2 -> 3 -> 4
    ...
    @Test
     void test_shortcut_needed_bidirectional() {
        // 0 -> 1 -> 2 -> 3 -> 4
        CHPreparationGraph graph = CHPreparationGraph.edgeBased(5, 4, (in, via, out) -> in == out ? 10 : 0);
        int edge = 0;
    ...
    @Test
     void test_witness_bidirectional() {
        // 0 -> 1 -> 2 -> 3 -> 4
        //       \       /
        //        \> 5 >/
        CHPreparationGraph graph = CHPreparationGraph.edgeBased(6, 6, (in, via, out) -> in == out ? 10 : 0);
