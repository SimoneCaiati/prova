...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class NodeBasedNodeContractorTest {
    ...
    public NodeBasedNodeContractorTest() throws MMapDataAccess.MappaExce {
    }
    ...
    @ValueSource(booleans = {true, false})
     void testDirectedGraph(boolean reverse) throws MMapDataAccess.MappaExce {
        //5 6 7
        // \|/
        //4-3_1<-\ 10
        //     \_|/
    ...
    @Test
     void testFindShortcuts_Roundabout() throws MMapDataAccess.MappaExce {
        // 1 -- 3 -- 4 ---> 5 ---> 6 -- 7
        //            \           /
        //             <--- 8 <--- 
    ...
    @ParameterizedTest
    @ValueSource(booleans = {true, false})
     void testShortcutMergeBug(boolean reverse) throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testContractNode_directed_shortcutRequired() throws MMapDataAccess.MappaExce {
        // 0 --> 1 --> 2
    ...
    @Test
     void testContractNode_directed_shortcutRequired_reverse() throws MMapDataAccess.MappaExce {
        // 0 <-- 1 <-- 2
    ...
    @Test
     void testContractNode_bidirected_shortcutsRequired() throws MMapDataAccess.MappaExce {
        // 0 -- 1 -- 2
    ...
    @Test
     void testContractNode_directed_withWitness() throws MMapDataAccess.MappaExce {
        // 0 --> 1 --> 2
        //  \_________/
    ...
    @Test
     void testNodeContraction_shortcutDistanceRounding() throws MMapDataAccess.MappaExce {
     ...
     */
    @Test
     void testNodeContraction_shortcutWeightRounding() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testNodeContraction_preventUnnecessaryShortcutWithLoop() throws MMapDataAccess.MappaExce {
