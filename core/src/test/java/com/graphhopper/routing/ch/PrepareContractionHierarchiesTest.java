 ...
 * @author Peter Karich
 */
 class PrepareContractionHierarchiesTest {
    ...
    private BaseGraph createGraph() throws MMapDataAccess.MappaExce {
        return new BaseGraph.Builder(encodingManager).create();
    }

    @Test
     void testReturnsCorrectWeighting() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testAddShortcuts() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testMoreComplexGraph() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testDirectedGraph() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testDirectedGraph2() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testRoundaboutUnpacking() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testDisconnects() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //            4
        //            v
        //            0
        //            v
    ...
    @Test
     void testStallOnDemandViaVirtuaNode_issue1574() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testCircleBug() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        //  /--1
        // -0--/
        //  |
    ...
    @Test
     void testBug178() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        // 5--------6__
        // |        |  \
        // 0-1->-2--3--4
        //   \-<-/
    ...
    @Test
     void testMultiplePreparationsIdenticalView() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testMultiplePreparationsDifferentView() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        BooleanEncodedValue carAccessEnc = new SimpleBooleanEncodedValue("car_access", true);
        BooleanEncodedValue bikeAccessEnc = new SimpleBooleanEncodedValue("bike_access", true);
        DecimalEncodedValue carSpeedEnc = new DecimalEncodedValueImpl("car_speed", 5, 5, false);
        DecimalEncodedValue bikeSpeedEnc = new DecimalEncodedValueImpl("bike_speed", 4, 2, false);
    ...
    @Test
     void testReusingNodeOrdering() throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
        ...
        GHUtility.buildRandomGraph(new GHUtility.Salmo(graph, rnd, numNodes, 1.3, true, true), car1AccessEnc, null, null, 0.7, 0.9, 0.8);
        AllEdgesIterator iter = graph.getAllEdges();
        while (iter.next()) {
    ...
    private void checkPath(BaseGraph g, CHConfig c, int expShortcuts, double expDistance, IntIndexedContainer expNodes, int[] nodeOrdering) throws PrepareContractionHierarchies.PrepareExce, MMapDataAccess.MappaExce {
    ...
    private PrepareContractionHierarchies createPrepareContractionHierarchies(BaseGraph g) throws MMapDataAccess.MappaExce {
        return createPrepareContractionHierarchies(g, chConfig);
    }

    private PrepareContractionHierarchies createPrepareContractionHierarchies(BaseGraph g, CHConfig p) throws MMapDataAccess.MappaExce {
        if (!g.isFrozen())
            g.freeze();
