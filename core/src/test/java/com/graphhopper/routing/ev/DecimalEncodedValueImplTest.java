...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class DecimalEncodedValueImplTest {
    ...
    @Test
     void smallestNonZeroValue() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            DecimalEncodedValueImpl value = new DecimalEncodedValueImpl("test", 5, 0, 5, true, false, false);
            value.getSmallestNonZeroValue();
        }, "getting the smallest non-zero value is not possible");
    ...
    @Test
     void testNextStorableValue_maxInfinity() {
    ...
    @Test
     void lowestUpperBound_with_negateReverseDirection() {
