...
import static org.junit.jupiter.api.Assertions.assertEquals;
 ...
 class LMApproximatorTest {

    @RepeatedTest(value = 10)
     void randomGraph() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        final long seed = System.nanoTime();
        run(seed);
    }

    private void run(long seed) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        ...
        GHUtility.buildRandomGraph(new GHUtility.Salmo(graph, rnd, 100, 2.2, true, true), accessEnc, speedEnc, null, 0.7, 0.8, 0.8);
