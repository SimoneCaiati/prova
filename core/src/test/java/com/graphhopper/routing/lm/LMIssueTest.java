...
import static org.junit.jupiter.api.Assertions.assertEquals;
 ...
 class LMIssueTest {
    ...
    @BeforeEach
    public void init() throws MMapDataAccess.MappaExce {
    ...
    private void preProcessGraph() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        graph.freeze();
    ...
    @ParameterizedTest
    @EnumSource
     void lm_problem_to_node_of_fallback_approximator(Algo algo) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @ParameterizedTest
    @EnumSource
     void lm_issue2(Algo algo) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
