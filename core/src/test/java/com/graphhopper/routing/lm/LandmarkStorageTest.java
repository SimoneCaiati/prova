 ...
 */
 class LandmarkStorageTest {
    ...
    @Test
     void testSetGetWeight() throws MMapDataAccess.MappaExce {
        ...
        lms.getinternalda().setInt(0, Integer.MAX_VALUE);
    ...
    @Test
     void testWithSubnetworks() throws MMapDataAccess.MappaExce {
        // 0-1-2..4-5->6
    ...
    @Test
     void testWithStronglyConnectedComponent() throws MMapDataAccess.MappaExce {
        // 0 - 1 - 2 = 3 - 4
        GHUtility.setSpeed(60, true, true, accessEnc, speedEnc, graph.edge(0, 1).setDistance(10.1));
        GHUtility.setSpeed(60, true, true, accessEnc, speedEnc, graph.edge(1, 2).setDistance(10.2));
    ...
    @Test
     void testWithOnewaySubnetworks() throws MMapDataAccess.MappaExce {
        // 0 -- 1 -> 2 -> 3
        // 4 -- 5 ->/
        GHUtility.setSpeed(60, true, true, accessEnc, speedEnc, graph.edge(0, 1).setDistance(10.1));
    ...
    @Test
     void testWeightingConsistence1() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testWeightingConsistence2() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testWithBorderBlocking() throws MMapDataAccess.MappaExce {
