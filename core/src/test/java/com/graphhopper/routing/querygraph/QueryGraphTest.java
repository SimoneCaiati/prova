 ...
 */
 class QueryGraphTest {
    ...
    @Test
     void testUseMeanElevation() throws MMapDataAccess.MappaExce {
        g.close();
    ...
    @Test
     void testAvoidDuplicateVirtualNodesIfIdentical() {
        initGraph(g);
    ...
    @Test
     void testTurnCostsProperlyPropagated_Issue282() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testUnfavoredEdgeDirections() {
        NodeAccess na = g.getNodeAccess();
        // 0 <-> x <-> 1
        //       2
        na.setNode(0, 0, 0);
    ...
    @Test
     void testUnfavorVirtualEdgePair() {
        // setup graph
        //   ____
        //  |    |
        //  |    |
    ...
    @Test
     void testInternalAPIOriginalEdgeKey() {
        initGraph(g);
    ...
    @Test
     void testWayGeometry_edge() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testWayGeometry_pillar() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //   1
        //    \
        //     * x
        //    /
    ...
    @Test
     void testVirtualEdgeDistance() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        //   x
        // -----
        // |   |
        // 0   1
        ...
        na.setNode(2, 2, 2);
        DistanceCalc distCalc = DistancePlaneProjection.getInstancePlane();
        double dist = 0;
    ...
    @Test
     void testVirtualEdgeIds() throws MMapDataAccess.MappaExce {
        // virtual nodes:     2
        //                0 - x - 1
        // virtual edges:   1   2
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
       ...
       due(edge_0x, edge_x0, edge_x1, edge_1x);
       ...
       due(queryGraph.getEdgeIteratorStateForKey(2), queryGraph.getEdgeIteratorStateForKey(3), queryGraph.getEdgeIteratorStateForKey(4), queryGraph.getEdgeIteratorStateForKey(5));
   ...
   private void due(EdgeIteratorState edge_0x, EdgeIteratorState edge_x0, EdgeIteratorState edge_x1, EdgeIteratorState edge_1x) {
   ...
   private static void uno(QueryGraph queryGraph) {
   ...
   @Test
     void testVirtualEdgeIds_reverse() throws MMapDataAccess.MappaExce {
        // virtual nodes:     2
        //                0 - x - 1
        // virtual edges:   1   2
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
