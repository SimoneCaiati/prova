 ...
 * @author Peter Karich
 */
 class PrepareRoutingSubnetworksTest {

    private static BaseGraph createSubnetworkTestStorage(EncodingManager encodingManager, BooleanEncodedValue accessEnc1, DecimalEncodedValue speedEnc1, BooleanEncodedValue accessEnc2, DecimalEncodedValue speedEnc2) throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testPrepareSubnetworks_oneVehicle() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testPrepareSubnetworks_twoVehicles() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testPrepareSubnetwork_withTurnCosts() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
    ...
    private BaseGraph createSubnetworkTestStorageWithOneWays(EncodingManager em, BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc) throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testPrepareSubnetworks_withOneWays() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        BooleanEncodedValue subnetworkEnc = Subnetwork.create("car");
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).add(subnetworkEnc).build();
    ...
    @Test
     void testNodeOrderingRegression() throws MMapDataAccess.MappaExce {
        // 1 -> 2 -> 0 - 3 - 4 - 5
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        BooleanEncodedValue subnetworkEnc = Subnetwork.create("car");
