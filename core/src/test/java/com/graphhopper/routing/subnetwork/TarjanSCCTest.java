...
class TarjanSCCTest {
    ...
    public TarjanSCCTest() throws MMapDataAccess.MappaExce {
    ...
    private void doImplicitVsExplicit(boolean excludeSingle) {
        ...
        GHUtility.buildRandomGraph(new GHUtility.Salmo(graph, rnd, 1_000, 2, true, true),
