...
import static org.junit.jupiter.api.Assertions.assertEquals;
 ...
 class AccessFilterTest {
    ...
    public AccessFilterTest() throws MMapDataAccess.MappaExce {
    }

    @Test
     void testAccept_fwdLoopShortcut_acceptedByInExplorer() throws MMapDataAccess.MappaExce {
        // 0-1
        //  \|
        //   2
        ...
        chBuilder.addShortcutEdgeBased(new CHStorageBuilder.Classe3(0, 0), PrepareEncoder.getScFwdDir(), 5, 0, 2, 0, 5);
