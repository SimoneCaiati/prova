 ...
 * @author ratrun
 */
 class BikeTagParserTest extends AbstractBikeTagParserTester {
    ...
    @Test
     void testSpeedAndPriority() {
        ...
        miomioquattro(way, cyclewaySpeed);

        way.clearTags();
        way.setTag("highway", "path");
        assertPriorityAndSpeed(SLIGHT_AVOID.getValue(), PUSHING_SECTION_SPEED, way);

        miomiocinque(way, cyclewaySpeed);

        mioeavest(way, cyclewaySpeed);
    ...
    private void mioeavest(ReaderWay way, int cyclewaySpeed) {
        way.clearTags();
    ...
    private void miomiosette(ReaderWay way) {
    ...
    private void miomiosei(ReaderWay way) {
        way.clearTags();
        way.setTag("highway", "track");
        way.setTag("surface", "paved");
        assertPriorityAndSpeed(UNCHANGED.getValue(), 18, way);
    ...
    private void miomiomio(ReaderWay way) {
        way.clearTags();
        way.setTag("highway", "track");
    ...
    private void miomiocinque(ReaderWay way, int cyclewaySpeed) {
        // use pushing section
        way.clearTags();
        way.setTag("highway", "path");
        way.setTag("surface", "paved");
    ...
    private void miomioquattro(ReaderWay way, int cyclewaySpeed) {
        way.setTag("segregated", "no");
        assertPriorityAndSpeed(VERY_NICE.getValue(), cyclewaySpeed, way);
    ...
    private void miomiotre(ReaderWay way) {
        way.clearTags();
        way.setTag("highway", "footway");
        way.setTag("surface", "paved");
        way.setTag("bicycle", "yes");
    ...
    private void miomiodue(ReaderWay way) {
        way.clearTags();
    ...
    private void miomio(ReaderWay way) {
        way.clearTags();
        way.setTag("highway", "footway");
        assertPriorityAndSpeed(SLIGHT_AVOID.getValue(), PUSHING_SECTION_SPEED, way);
    ...
    private void mollysedici(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
        way.setTag("oneway", "yes");
    ...
    private void mollyquindici(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
        way.setTag("oneway", "yes");
    ...
    private void mollyquattordici(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
        way.setTag("oneway", "yes");
    ...
    private void mollytredici(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
        flags = parser.handleWayTags(encodingManager.createEdgeFlags(), way);
        assertTrue(parser.getAccessEnc().getBool(false, flags));
    ...
    private void mollydodici(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
    ...
    private void mollyundici(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
    ...
    private void mollydieci(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
    ...
    private void mollynove(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
    ...
    private void mollyotto(ReaderWay way) {
        IntsRef flags;
        way.setTag("highway", "tertiary");
        way.setTag("oneway", "yes");
    ...
    private void mollysette(ReaderWay way) {
        IntsRef flags;
    ...
    private void mollysei(ReaderWay way) {
        IntsRef flags;
        way.clearTags();
        way.setTag("highway", "residential");
        way.setTag("oneway", "yes");
    ...
    private void mollycinque(ReaderWay way) {
        IntsRef flags;
        way.clearTags();
        way.setTag("highway", "residential");
        way.setTag("oneway", "-1");
    ...
    private void mollyquattro(ReaderWay way) {
        IntsRef flags;
        way.clearTags();
        way.setTag("highway", "tertiary");
    ...
    private void mollythree(ReaderWay way) {
        IntsRef flags;
        way.clearTags();
        way.setTag("highway", "tertiary");
        way.setTag("bicycle:forward", "use_sidepath");
    ...
    private void mollytwo(ReaderWay way) {
        IntsRef flags;
        way.clearTags();
        way.setTag("highway", "tertiary");
        way.setTag("oneway", "yes");
    ...
    private void molly(ReaderWay way) {
        IntsRef flags;
        way.clearTags();
        way.setTag("highway", "residential");
        way.setTag("oneway", "yes");
    ...
    @Test
     void testUnchangedRelationShouldNotInfluencePriority() {
        ReaderWay osmWay = new ReaderWay(1);
