 ...
 */
 class FootTagParserTest {
    ...
    @Test
     void testCombined() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testGraph() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(encodingManager).create();
    ...
    private void veviatanodue(ReaderWay way) {
    ...
    private void leviatano(ReaderWay way) {
    ...
    @Test
     void maxSpeed() throws MMapDataAccess.MappaExce {
