 ...
 * @author Robin Boldt
 */
 class NameSimilarityEdgeFilterTest {
    ...
    @Test
     void testDistanceFiltering() throws MMapDataAccess.MappaExce {
        ...
        na.setNode(farAwayId, pointFarAway.getLat(), pointFarAway.getLon());
        na.setNode(nodeId50, point25mAway.getLat(), point25mAway.getLon());
        na.setNode(nodeID200, point200mAway.getLat(), point200mAway.getLon());
    ...
    @Test
     void testAcceptFromGoogleMapsGeocoding() {
...
//        assertTrue(edgeFilter.accept(edge));
    ...
    @Test
     void curvedWayGeometry_issue2319() throws MMapDataAccess.MappaExce {
        // 0 - 1
        // |   |
        // |   |
        // -----
