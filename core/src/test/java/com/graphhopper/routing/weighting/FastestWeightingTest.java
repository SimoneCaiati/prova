...
import static com.graphhopper.routing.weighting.FastestWeighting.roadAccessDestinationFactor;
import static com.graphhopper.routing.weighting.FastestWeighting.accessPrivateFactor;
 ...
 */
 class FastestWeightingTest {
    ...
    @Test
     void testMinWeightHasSameUnitAs_getWeight() {
    ...
    @Test
     void testWeightWrongHeading() {
        ...
        VirtualEdgeIteratorState virtEdge = new VirtualEdgeIteratorState(new VirtualEdgeIteratorState.InnerVirtual(0, GHUtility.createEdgeKey(1, false, false), 1), 2, 10,
    ...
    @Test
     void testTime() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void calcWeightAndTime_withTurnCosts() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void calcWeightAndTime_uTurnCosts() throws MMapDataAccess.MappaExce {
        BaseGraph graph = new BaseGraph.Builder(encodingManager).withTurnCosts(true).create();
    ...
    @Test
     void calcWeightAndTime_withTurnCosts_shortest() throws MMapDataAccess.MappaExce {
        BaseGraph graph = new BaseGraph.Builder(encodingManager).withTurnCosts(true).create();
...
//        assertEquals(105, AbstractWeighting.calcWeightWithTurnWeight(weighting, edge, false, 0), 1.e-6);
    ...
    @Test
     void testDestinationTag() throws MMapDataAccess.MappaExce {
        ...
        FastestWeighting weighting = new FastestWeighting(carAccessEnc, carSpeedEnc, roadAccessEnc,
                new PMap().putObject(roadAccessDestinationFactor, 10), TurnCostProvider.NO_TURN_COST_PROVIDER);
        FastestWeighting bikeWeighting = new FastestWeighting(bikeAccessEnc, bikeSpeedEnc, roadAccessEnc,
                new PMap().putObject(roadAccessDestinationFactor, 1), TurnCostProvider.NO_TURN_COST_PROVIDER);
    ...
    @Test
     void testPrivateTag() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue carAccessEnc = new SimpleBooleanEncodedValue("car_access", true);
        DecimalEncodedValue carSpeedEnc = new DecimalEncodedValueImpl("car_speed", 5, 5, false);
        BooleanEncodedValue bikeAccessEnc = new SimpleBooleanEncodedValue("bike_access", true);
        DecimalEncodedValue bikeSpeedEnc = new DecimalEncodedValueImpl("bike_speed", 4, 2, false);
        ...
        FastestWeighting weighting = new FastestWeighting(carAccessEnc, carSpeedEnc, roadAccessEnc,
                new PMap().putObject(accessPrivateFactor, 10), TurnCostProvider.NO_TURN_COST_PROVIDER);
        FastestWeighting bikeWeighting = new FastestWeighting(bikeAccessEnc, bikeSpeedEnc, roadAccessEnc,
                new PMap().putObject(accessPrivateFactor, 1.2), TurnCostProvider.NO_TURN_COST_PROVIDER);
