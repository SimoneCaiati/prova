...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class ConditionalExpressionVisitorTest {
    ...
    @Test
     void testStringExpression() {
        ...
        // unknown String should result in a negative integer. if1 we would throw an Exception here the same script that
    ...
    @Test
     void isValidAndSimpleCondition() {
        NameValidator validVariable = s -> isValidVariableName(s)
                || Helper.toUpperCase(s).equals(s) || s.equals("road_class") || s.equals("toll");
