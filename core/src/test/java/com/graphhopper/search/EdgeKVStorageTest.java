...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class EdgeKVStorageTest {

    private final static String location = "./target/edge-kv-storage";

    private EdgeKVStorage create() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void putSame() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void putAB() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
    ...
    @Test
     void getForwardBackward() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
    ...
    @Test
     void putEmpty() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
        ...
        try {
            int result = (int) index.add(createList("", null));
        ...
        try {
            index.add(createList("blup", null));
        } catch (IllegalArgumentException ex) {
            thrown = ex;
        }
        ...
        assertNotNull(thrown);
        try {
            index.add(createList(null, null));
        } catch (IllegalArgumentException ex) {
            thrown = ex;
        }
    ...
    @Test
     void putMany() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
    ...
    @Test
    void putManyKeys() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
        ...
        // Assertion per verificare che l'esecuzione non abbia generato un'eccezione
        assertTrue(true);
    }
     ...
     @Test
     void testNoErrorOnLargeStringValue() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
        String str = "";
        for (int i = 0; i < 127; i++) {
            str += "ß";
    ...
    @Test
     void testTooLongStringValueError() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
        String longString = "Бухарестская улица (http://ru.wikipedia.org/wiki" +
        ...
        String tooLongString = "sdfsdfds" + "Б".repeat(256 * 3);

        IllegalArgumentException thrown = null;
        try {
            index.add(createList("", longString + tooLongString));
        } catch (IllegalArgumentException ex) {
            thrown = ex;
        }
    ...
    @Test
     void testNoErrorOnLargestByteArray() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
        ...
        try {
            index.add(createKV("myval2", biggerByteArray));
        } catch (IllegalArgumentException ex) {
            e = ex;
        }
    ...
    @Test
     void testIntLongDoubleFloat() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
    ...
    @Test
     void testIntLongDoubleFloat2() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
        List<KeyValue> list = new ArrayList<>();
    ...
    @Test
     void testFlush() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testLoadKeys() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        Helper.removeDir(new File(location));
    ...
    @Test
     void testEmptyKey() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
    ...
    @Test
     void testSameByteArray() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
    ...
    @Test
     void testUnknownValueClass() throws MMapDataAccess.MappaExce {
        EdgeKVStorage index = create();
        IllegalArgumentException ex = null;
        try {
            index.add(createList("mykey", new Object()));
        } catch (IllegalArgumentException e) {
            ex = e;
        }
