...
public abstract class AbstractDirectoryTester {
    ...
    @Test
    public void testNoErrorForDACreate() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        Directory dir = createDir();
        da = dir.create("testing");
        da.create(100);
        da.flush();
        assertTrue(da != null && da instanceof DataAccess);
    }
}
