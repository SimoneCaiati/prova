...
public abstract class AbstractGraphStorageTester {
    ...
    protected BaseGraph createGHStorage() throws MMapDataAccess.MappaExce {
    ...
    abstract BaseGraph createGHStorage(String location, boolean is3D) throws MMapDataAccess.MappaExce;
    ...
    @Test
    public void testSetTooBigDistance_435() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();

        double maxDist = BaseGraphNodesAndEdges.maxDist;
    ...
    @Test
    public void testSetNodes() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testPropertiesWithNoInit() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testCreateLocation() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testEdges() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testUnidirectional() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testUnidirectionalEdgeFilter() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testUpdateUnidirectional() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testCopyProperties() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testGetLocations() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
        NodeAccess na = graph.getNodeAccess();
        na.setNode(0, 12, 23);
        na.setNode(1, 22, 23);
    ...
    @Test
    public void testAddLocation() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testDirectional() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testDozendEdges() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
        graph.edge(1, 2).setDistance(12).set(carAccessEnc, true, true);
        int nn = 1;
    ...
    @Test
    public void testCheckFirstNode() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
        // no nodes added yet
    ...
    @Test
    public void testBounds() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testFlags() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testEdgeProperties() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testCreateDuplicateEdges() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
        graph.edge(2, 1).setDistance(12).set(carAccessEnc, true, true);
        graph.edge(2, 3).setDistance(12).set(carAccessEnc, true, true);
    ...
    @Test
    public void testIdenticalNodes() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testIdenticalNodes2() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testEdgeReturn() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testPillarNodes() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
        NodeAccess na = graph.getNodeAccess();
    ...
    @Test
    public void testFootMix() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testGetAllEdges() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
    ...
    @Test
    public void testEdgeKVStorage() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
        EdgeIteratorState iter1 = graph.edge(0, 1).setDistance(10).set(carAccessEnc, true, true);
    ...
    @Test
    public void test8AndMoreBytesForEdgeFlags() throws MMapDataAccess.MappaExce {
    ...
    @Test
    public void testEnabledElevation() throws MMapDataAccess.MappaExce {
    ...
    @Test
    public void testDontGrowOnUpdate() throws MMapDataAccess.MappaExce {
        graph = createGHStorage(defaultGraphLoc, true);
        NodeAccess na = graph.getNodeAccess();
        assertTrue(na.is3D());
    ...
    @Test
    public void testDetachEdge() throws MMapDataAccess.MappaExce {
        graph = createGHStorage();
        graph.edge(0, 1).setDistance(2).set(carAccessEnc, true, true);
