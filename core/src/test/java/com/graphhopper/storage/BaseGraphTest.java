 ...
 * @author Peter Karich
 */
 class BaseGraphTest extends AbstractGraphStorageTester {
    @Override
    public BaseGraph createGHStorage(String location, boolean enabled3D) throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testSave_and_fileFormat() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testSave_and_Freeze() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        graph = newGHStorage(new RAMDirectory(defaultGraphLoc, true), true).create(defaultSize);
        graph.edge(1, 0);
        graph.freeze();
    ...
    @Test
     void testDoThrowExceptionIfDimDoesNotMatch() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testMultipleDecoupledEdges() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testInternalReverse() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testDecoupledEdgeIteratorStates() throws MMapDataAccess.MappaExce {
        BaseGraph storage = createGHStorage();
    ...
    @Test
     void testEdgeKey() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testEdgeKey_loop() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(encodingManager).create();
    ...
    @Test
     void outOfBounds() throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
        assertThrows(IllegalArgumentException.class, () -> graph.getEdgeIteratorState(0, Integer.MIN_VALUE));
    }

    @Test
     void setGetFlagsRaw() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void setGetFlags() throws MMapDataAccess.MappaExce {
        BaseGraph graph = createGHStorage();
