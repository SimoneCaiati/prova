 ...
 * @author Karl Hübner
 */
 class BaseGraphWithTurnCostsTest extends BaseGraphTest {
    ...
    @Override
    @Test
    public void testSave_and_fileFormat() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testEnsureCapacity() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testInitializeTurnCost() throws MMapDataAccess.MappaExce {
