...
class CHStorageTest {
    ...
    @Test
    void setAndGetLevels() throws MMapDataAccess.MappaExce {
    ...
    @Test
    void createAndLoad(@TempDir Path path) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        {
