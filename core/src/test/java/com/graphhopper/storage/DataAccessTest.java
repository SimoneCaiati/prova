...
public abstract class DataAccessTest {
    ...
    @Test
    public void testLoadFlush() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
    public void testExceptionIfNoEnsureCapacityWasCalled() throws RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        DataAccess da = createDataAccess(name);
        assertFalse(da.loadExisting());
        try {
            da.setInt(2 * 4, 321);
    ...
    @Test
    public void testLoadClose() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        DataAccess da = createDataAccess(name);
        da.create(300);
        da.setInt(2 * 4, 321);
        da.flush();
    ...
    @Test
    public void testHeader() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        DataAccess da = createDataAccess(name);
        da.create(300);
    ...
    @Test
    public void testEnsureCapacity() throws MMapDataAccess.MappaExce {
        DataAccess da = createDataAccess(name);
        da.create(128);
        da.setInt(31 * 4, 200);
    ...
    @Test
    public void testSegments() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
    public void testSegmentSize() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMDataAccess.RamExce, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
    public void testSet_GetBytes() throws MMapDataAccess.MappaExce {
        DataAccess da = createDataAccess(name);
        da.create(300);
        assertEquals(128, da.getSegmentSize());
    ...
    @Test
    public void testSet_GetByte() throws MMapDataAccess.MappaExce {
        DataAccess da = createDataAccess(name);
        da.create(300);
    ...
    @Test
    public void testSet_Get_Short_Long() throws MMapDataAccess.MappaExce {
        DataAccess da = createDataAccess(name);
        da.create(300);
