...
import static org.junit.jupiter.api.Assumptions.assumeTrue;
 ...
 class ShortcutUnpackerTest {
    ...
    private static final class Fixture {
        ...
        Fixture(boolean edgeBased) throws MMapDataAccess.MappaExce {
        ...
        private void shortcut(int baseNode, int adjNode, int skip1, int skip2, int origKeyFirst, int origKeyLast, boolean reverse) {
            ...
            if (edgeBased) {
                chBuilder.addShortcutEdgeBased(new CHStorageBuilder.Classe3(baseNode, adjNode), flags, weight, skip1, skip2, origKeyFirst, origKeyLast);
            } else {
    ...
    @ArgumentsSource(FixtureProvider.class)
     void testUnpacking(Fixture f) throws MMapDataAccess.MappaExce {
        // 0-1-2-3-4-5-6
    ...
    private static void lello(TestVisitor visitor) {
        assertEquals(IntArrayList.from(0, 1, 2, 3, 4, 5), visitor.edgeIds);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void loopShortcut(Fixture f) throws MMapDataAccess.MappaExce {
    ...
    private static void lellodue(TestVisitor visitor) {
        assertEquals(IntArrayList.from(0, 1, 2, 3, 4, 5), visitor.edgeIds);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void withTurnWeighting(Fixture f) throws MMapDataAccess.MappaExce {
