...
public class LocationIndexTreeTest {
    ...
    // |____/   4
    // 2-------/
    Graph createTestGraph(EncodingManager em, BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc) throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testSnappedPointAndGeometry() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testBoundingBoxQuery2() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testBoundingBoxQuery1() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        Graph graph = createTestGraph2();
        LocationIndexTree index = (LocationIndexTree) createIndexNoPrepare(graph, 500).prepareIndex();
    ...
    @Test
     void testMoreReal() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    //-1|  2---------/
    //  |
    private Graph createTestGraphWithWayGeometry() throws MMapDataAccess.MappaExce {
        BaseGraph graph = new BaseGraph.Builder(encodingManager).create();
        NodeAccess na = graph.getNodeAccess();
        na.setNode(0, 0.5, -0.5);
        na.setNode(1, -0.5, -0.5);
    ...
    @Test
     void testWayGeometry() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testFindingWayGeometry() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testEdgeFilter() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        Graph graph = createTestGraph(encodingManager, accessEnc, speedEnc);
    ...
    // see testgraph2.jpg
    Graph createTestGraph2() throws MMapDataAccess.MappaExce {
        BaseGraph graph = new BaseGraph.Builder(encodingManager).create();
        NodeAccess na = graph.getNodeAccess();
    ...
    @Test
     void testRMin() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        Graph graph = createTestGraph(encodingManager, accessEnc, speedEnc);
    ...
    @Test
     void testSearchWithFilter_issue318() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    // 4--5--6--7
    @Test
     void testCrossBoundaryNetwork_issue667() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        BaseGraph graph = new BaseGraph.Builder(encodingManager).create();
        NodeAccess na = graph.getNodeAccess();
    ...
    @Test
     void testSimpleGraph() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testSimpleGraph2() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 5, 5, false);
        EncodingManager em = EncodingManager.start().add(accessEnc).add(speedEnc).build();
        BaseGraph g = new BaseGraph.Builder(em).create();
    ...
    @Test
     void testSinglePoints120() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
    ...
    @Test
     void testSinglePoints32() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        BaseGraph g = createSampleGraph(encodingManager, accessEnc, speedEnc);
        LocationIndexTree idx = (LocationIndexTree) createIndexNoPrepare(g, 500000).prepareIndex();
    ...
    @Test
     void testNoErrorOnEdgeCase_lastIndex() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        ...
        assertEquals(locs, g.getNodes(), "Index was not created successfully");

    }


    public BaseGraph createSampleGraph(EncodingManager encodingManager, BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc) throws MMapDataAccess.MappaExce {
        BaseGraph graph = new BaseGraph.Builder(encodingManager).create();
...
//   lon: 0   1   2   3   4   5
    ...
    @Test
     void testDifferentVehicles() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        BooleanEncodedValue carAccessEnc = new SimpleBooleanEncodedValue("car_access", true);
        DecimalEncodedValue carSpeedEnc = new DecimalEncodedValueImpl("car_speed", 5, 5, false);
    ...
    @ValueSource(booleans = {true, false})
     void closeToTowerNode(boolean snapAtBase) throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 0 - 1
        BaseGraph graph = new BaseGraph.Builder(encodingManager).create();
        NodeAccess na = graph.getNodeAccess();
        ...
        double distFromTower = distCalc.calcDist(queryPoint.getLat(), queryPoint.getLon(), na.getLat(snapNode), na.getLon(snapNode));
        assertTrue(distFromTower < 0.1);
        Snap snap = index.findClosest(queryPoint.getLat(), queryPoint.getLon(), EdgeFilter.ALL_EDGES);
        assertEquals(Snap.Position.TOWER, snap.getSnappedPosition());
    }

    @Test
     void queryBehindBeforeOrBehindLastTowerNode() throws MMapDataAccess.MapExce, RAMDataAccess.RamExce2, RAMIntDataAccess.RamIntExce, MMapDataAccess.MappaExce {
        // 0 -x- 1
        BaseGraph graph = new BaseGraph.Builder(encodingManager).create();
        NodeAccess na = graph.getNodeAccess();
