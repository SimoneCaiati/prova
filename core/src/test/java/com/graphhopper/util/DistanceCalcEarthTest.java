 ...
 */
 class DistanceCalcEarthTest {
    ...
    @Test
     void testEdgeDistance3d() {
        double dist = dc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(49.94241, 11.544356, 0),
        ...
        // test identical lats
        dist = dc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(49.936299, 11.543992, 0),
                49.9357, 11.543047, 0,
                49.9357, 11.549227, 0);
        expectedDist = dc.calcNormalizedDist(49.936299, 11.543992,
                49.9357, 11.543992);
    ...
    @Test
     void testEdgeDistance3dEarth() {
        double dist = dc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(0, 0.5, 10),
                0, 0, 0,
                0, 1, 0);
    ...
    @Test
     void testEdgeDistance3dEarthNaN() {
        double dist = dc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(0, 0.5, Double.NaN),
                0, 0, 0,
                0, 1, 0);
    ...
    @Test
     void testEdgeDistance3dPlane() {
        DistanceCalc calc = new DistancePlaneProjection();
        double dist = calc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(0, 0.5, 10),
                0, 0, 0,
                0, 1, 0);
    ...
    @Test
     void testEdgeDistanceStartEndSame() {
        DistanceCalc calc = new DistancePlaneProjection();
        // just change elevation
        double dist = calc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(0, 0, 10),
                0, 0, 0,
                0, 0, 0);
        assertEquals(10, calc.calcDenormalizedDist(dist), 1e-4);
        // just change lat
        dist = calc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(1, 0, 0),
                0, 0, 0,
                0, 0, 0);
        assertEquals(DistanceCalcEarth.METERS_PER_DEGREE, calc.calcDenormalizedDist(dist), 1e-4);
        // just change lon
        dist = calc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(0, 1, 0),
                0, 0, 0,
                0, 0, 0);
        assertEquals(DistanceCalcEarth.METERS_PER_DEGREE, calc.calcDenormalizedDist(dist), 1e-4);
    }
    ...
    @Test
     void testEdgeDistanceStartEndDifferentElevation() {
        DistanceCalc calc = new DistancePlaneProjection();
        // just change elevation
        double dist = calc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(0, 0, 10),
                0, 0, 0,
