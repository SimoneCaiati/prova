...
import static org.junit.jupiter.api.Assertions.assertEquals;
 ...
 class DistanceCalcEuclideanTest {

    @Test
     void testCrossingPointToEdge() {
    ...
    @Test
     void testCalcNormalizedEdgeDistance() {
        DistanceCalcEuclidean distanceCalc = new DistanceCalcEuclidean();
    ...
    @Test
     void testCalcNormalizedEdgeDistance3dStartEndSame() {
        DistanceCalcEuclidean distanceCalc = new DistanceCalcEuclidean();
        double distance = distanceCalc.calcNormalizedEdgeDistance3D(new DistanceCalc.InnerCalc(0, 3, 4), 0, 0, 0, 0, 0, 0);
