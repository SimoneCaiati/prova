 ...
 */
 class InstructionListTest {
    ...
    Graph createTestGraph() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testWayList() throws MMapDataAccess.MappaExce {
        ...
        // spcial case of identical start and end
    ...
    @Test
     void testWayList2() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
        //   2
        //    \.  5
        //      \/
    ...
    @Test
     void testNoInstructionIfSameStreet() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
        //   2
        //    \.  5
        //      \/
    ...
    @Test
     void testNoInstructionIfSlightTurnAndAlternativeIsSharp() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
    ...
    @Test
     void testNoInstructionIfSlightTurnAndAlternativeIsSharp2() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
    ...
    @Test
     void testNoInstructionIfSlightTurnAndAlternativeIsSharp3() throws MMapDataAccess.MappaExce {
    ...
    @Test
     void testInstructionIfTurn() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
        DecimalEncodedValue speedEnc = new DecimalEncodedValueImpl("speed", 4, 2, false);
        EncodingManager tmpEM = new EncodingManager.Builder().add(accessEnc).add(speedEnc).build();
        EnumEncodedValue<RoadClass> rcEV = tmpEM.getEnumEncodedValue(RoadClass.KEY, RoadClass.class);
    ...
    @Test
     void testInstructionIfSlightTurnForCustomProfile() throws MMapDataAccess.MappaExce {
        BooleanEncodedValue accessEnc = new SimpleBooleanEncodedValue("access", true);
    ...
    @Test
     void testInstructionWithHighlyCustomProfileWithRoadsBase() throws MMapDataAccess.MappaExce {
        ...
        customModel.addToPriority(Statement.if1("road_class == PEDESTRIAN", Statement.Op.MULTIPLY, "0"));
    ...
    @Test
     void testEmptyList() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
    ...
    @Test
     void testFind() throws MMapDataAccess.MappaExce {
        BaseGraph g = new BaseGraph.Builder(carManager).create();
        //   n-4-5   (n: pillar node)
        //   |
        // 7-3-2-6
