 ...
 */
 class RamerDouglasPeuckerTest {
    ...
    @Test
     void testSimplifyCheckPointCount() {
        PointList pointList = new PointList();
        pointList.parse2DJSON(points1);
    ...
    @Test
     void testSimplifyCheckPointOrder() {
        PointList pointList = new PointList();
    ...
    @Test
     void test3dPathSimplifyElevationDisabled() {
        PointList pointList = new PointList(5, true);
        pointList.add(0, 0, 0);
    ...
    @Test
     void test3dPathSimplifyElevationMaxDistFive() {
        PointList pointList = new PointList(5, true);
        pointList.add(0, 0, 0);
    ...
    @Test
     void test3dPathSimplifyWithMissingElevation() {
        PointList pointList = new PointList(5, true);
        pointList.add(0, 0, 0);
    ...
    @Test
     void test3dSimplifyStartEndSame() {
    ...
    @Test
     void test2dSimplifyStartEndSame() {
