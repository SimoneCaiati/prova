...
public class NavigateResource {
    ...
    public Response doGet(
        ...
        unit = methodNavigate1(voiceUnits);
        ...
        if (!ghResponse.hasErrors() && !favoredHeadings.isEmpty()) {
            GHResponse noHeadingResponse = calcRoute(Collections.emptyList(), requestPoints, ghProfile, localeStr, enableInstructions, minPathPrecision);
    ...
    private static DistanceUtils.Unit methodNavigate1(String voiceUnits) {
        DistanceUtils.Unit unit;
