...
public class NavigateResponseConverterTest {
    ...
    public static void beforeClass() {
        ...
        try {
            ...
            e.printStackTrace();
        } catch (closefile | TranslationMap.TransExce e) {
            e.printStackTrace();
    ...
    @Test
     void voiceInstructionsImperialTest() {
    ...
    @Test
     void voiceInstructionTranslationTest() {
    ...
    @Test
     void intersectionTest() {
        ...
        assertEquals(rsp.getBest().getWaypoints().get(0).getLon(), location.get(0).asDouble(), .000001);
        assertEquals(rsp.getBest().getWaypoints().get(0).getLat(), location.get(1).asDouble(), .000001);
