...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class VoiceInstructionConfigTest {

    private final TranslationMap trMap = new TranslationMap().doImport();
    private final Locale locale = Locale.ENGLISH;

    public VoiceInstructionConfigTest() throws TranslationMap.TransExce {
    }

    @Test
     void conditionalDistanceVICShouldHaveSameImportValueSize() {
    ...
    @Test
     void conditionalDistanceVICShouldReturnFirstFittingMetricValues() {
    ...
    @Test
     void conditionalDistanceVICShouldReturnFirstFittingImperialValues() {
    ...
    @Test
     void germanInitialVICMetricTest() {
        InitialVoiceInstructionConfig configMetric = new InitialVoiceInstructionConfig(FOR_HIGHER_DISTANCE_PLURAL.metric, trMap,
    ...
    @Test
     void fixedDistanceInitialVICMetricTest() {
    ...
    @Test
     void germanFixedDistanceInitialVICMetricTest() {
        FixedDistanceVoiceInstructionConfig configMetric = new FixedDistanceVoiceInstructionConfig(IN_HIGHER_DISTANCE_PLURAL.metric,
    ...
    @Test
     void fixedDistanceInitialVICImperialTest() {
