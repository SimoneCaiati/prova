...
public class Request {
    ...
    public Request(double fromLat, double fromLon, double toLat, double toLon) {
        this.points = Arrays.asList(new GHPointLocation(new GHPoint(fromLat, fromLon)), new GHPointLocation(new GHPoint(toLat, toLon)));
    }
