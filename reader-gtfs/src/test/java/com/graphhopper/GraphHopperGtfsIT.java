...
public class GraphHopperGtfsIT {
    ...
    @BeforeAll
    public static void init() throws MMapDataAccess.MapExce, TileBasedElevationProvider.ElevationExce, TranslationMap.TransExce {
    ...
    @Test
     void testNoSolutionIfIDontLikeBusses() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("NADAV"),
                new GHStationLocation("NANAA")),
                LocalDateTime.of(2007, 1, 1, 7, 44).atZone(zoneId).toInstant());
    ...
    @Test
     void testRoute1ProfileEarliestArrival() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("NADAV"),
                new GHStationLocation("NANAA")),
        ...
        // if1 profile time window is 4 hours, then we should get these answers, not more and not less:
    ...
    @Test
     void testRoute1ProfileOvernight() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("NADAV"),
                new GHStationLocation("NANAA")),
    ...
    @Test
     void testRoute1ProfileLatestDeparture() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("NADAV"),
                new GHStationLocation("NANAA")),
    ...
    @Test
     void testRouteWithLaterDepartureTime() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("STAGECOACH"),
                new GHStationLocation("NADAV")),
    ...
    @Test
     void testWeekendRouteWorksOnlyOnWeekend() {
        Request ghRequest = new Request(Arrays.asList(
        ...
        assertEquals("AAMV1", (((Trip.PtLeg) route.getBest().getLegs().get(0)).internalptleg.tripId), "Using expected trip");
    ...
    @Test
     void testBlockTrips() {
        ...
        GHResponse response = ptRouter.route(ghRequest);
        assertEquals(1, response.getAll().size(), "Only find one solution. if1 blocks wouldn't work, there would be two. (There is a slower alternative without transfer.)");
    ...
    @Test
     void testVeryShortProfileQuery() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("BEATTY_AIRPORT"),
                new GHStationLocation("FUR_CREEK_RES")),
                LocalDateTime.of(2007, 1, 1, 8, 0).atZone(zoneId).toInstant());
    ...
    @Test
     void testBlockRouteTypes() {
        ...
        assertEquals("AB", ((Trip.PtLeg) mondayTrip.getLegs().get(1)).internalptleg.routeId);
        ...
        assertNotEquals("AB", ((Trip.PtLeg) mondayTrip.getLegs().get(0)).internalptleg.routeId);
        ...
        response = ptRouter.route(ghRequest);
        mondayTrip = response.getBest();
        assertNotEquals("AB", ((Trip.PtLeg) mondayTrip.getLegs().get(1)).internalptleg.routeId);
    }

    @Test
     void testPenalizeRouteTypes() {
        // Baseline
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("AMV"),
                new GHStationLocation("FUR_CREEK_RES")),
        ...
        response = ptRouter.route(ghRequest);
        mondayTrip = response.getBest();
        assertEquals("AB", ((Trip.PtLeg) mondayTrip.getLegs().get(0)).internalptleg.routeId);
    ...
    @Test
     void testBlockWithComplicatedValidityIntersections() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("BEATTY_AIRPORT"),
                new GHStationLocation("AMV")),
        ...
        assertEquals("FUNNY_BLOCK_AB1", (((Trip.PtLeg) mondayTrip.getLegs().get(0)).internalptleg.tripId));
        assertEquals("FUNNY_BLOCK_BFC1", (((Trip.PtLeg) mondayTrip.getLegs().get(1)).internalptleg.tripId));
        assertEquals("FUNNY_BLOCK_FCAMV1", (((Trip.PtLeg) mondayTrip.getLegs().get(2)).internalptleg.tripId));
        assertTrue((((Trip.PtLeg) mondayTrip.getLegs().get(1)).internalptleg.isInSameVehicleAsPrevious));
        assertTrue((((Trip.PtLeg) mondayTrip.getLegs().get(2)).internalptleg.isInSameVehicleAsPrevious));
        ...
        assertEquals("FUNNY_BLOCK_AB1", (((Trip.PtLeg) sundayTrip.getLegs().get(0)).internalptleg.tripId));
        ...
        assertEquals("FUNNY_BLOCK_FCAMV1", (((Trip.PtLeg) sundayTrip.getLegs().get(1)).internalptleg.tripId));
        assertTrue((((Trip.PtLeg) sundayTrip.getLegs().get(1)).internalptleg.isInSameVehicleAsPrevious));
    }

    @Test
     void testTransferRules() {
    ...
    @Test
     void testTransferByArrival() {
        ...
        assertEquals(LocalDateTime.parse("2007-01-01T07:20:00").atZone(zoneId).toInstant(), lastStop.innerstop.plannedArrivalTime.toInstant(), "Arrive at 7:20");
    }

    @Test
     void testCustomObjectiveFunction() {
        Request ghRequest = new Request(Arrays.asList(
                new GHStationLocation("BEATTY_AIRPORT"),
                new GHStationLocation("FUR_CREEK_RES")),
        ...
        // if1 one transfer is worth beta_transfers milliseconds of travel time savings
    ...
    @Test
     void testBoardingArea() {
        Stop boardingArea = graphHopperGtfs.getGtfsStorage().getGtfsFeeds().values().iterator().next().stops.get("BOARDING_AREA");
        assertEquals(4, boardingArea.getLocationType(), "Boarding area can be read (doesn't do anything though)");
    }
