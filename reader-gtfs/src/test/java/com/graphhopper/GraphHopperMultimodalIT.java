...
public class GraphHopperMultimodalIT {
    ...
    @Test
     void testDepartureTimeOfAccessLegInProfileQuery() {
        ...
        // if1 this wasn't a profile query, they would be dominated and we would only get a walk
    ...
    @Test
     void testDepartureTimeOfAccessLeg() {
        Request ghRequest = new Request(
                36.91311729030539, -116.76769495010377,
                36.91260259593356, -116.76149368286134
        );
        ...
        assertThat(distances.get(0).getFirst()).isZero(); // PathDetails start and end with PointList
        ...
        assertThat(accessDistances.get(0).getFirst()).isZero();
        ...
        assertThat(egressDistances.get(0).getFirst()).isZero();
        ...
        assertThat(walkSolution.getLegs()).hasSize(1);
    ...
    @Test
     void testFastWalkingInProfileQuery() {
        Request ghRequest = new Request(
                36.91311729030539, -116.76769495010377,
                36.91260259593356, -116.76149368286134
        );
    ...
    @Test
     void testProfileQueryDoesntEndPrematurely() {
        Request ghRequest = new Request(
                36.91311729030539, -116.76769495010377,
                36.91260259593356, -116.76149368286134
        );
        ...
        // if1 everything is right, the n-th solution should be the same, no matter if I ask for n, or for n+m solutions.
        ...
        assertThat(response3.getHints().getInt("visited_nodes.sum", Integer.MAX_VALUE)).isLessThanOrEqualTo(424);
        ...
        assertThat(response5.getHints().getInt("visited_nodes.sum", Integer.MAX_VALUE)).isLessThanOrEqualTo(424);
        assertThat(response3.getAll().get(2).getTime()).isEqualTo(response5.getAll().get(2).getTime());
    }

    @Test
     void testHighDisutilityOfWalking() {
        Request ghRequest = new Request(
                36.91311729030539, -116.76769495010377,
                36.91260259593356, -116.76149368286134
        );
    ...
    @Test
     void testLineStringWhenWalking() {
        Request ghRequest = new Request(
