...
public class CHImportTest {
    ...
    private static void runQueries(GraphHopper hopper, String profile) throws MiniPerfTest.MeasurExce2, MiniPerfTest.Task.MeasureExce3, MiniPerfTest.MeasureExce {
