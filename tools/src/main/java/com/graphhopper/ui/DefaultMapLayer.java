...
public abstract class DefaultMapLayer implements MapLayer {
    ...
    private transient Graphics2D tmpG;
    private boolean buffering = true;
    // a bit transparent:

    private transient RescaleOp op = new RescaleOp(new float[]{1f, 1f, 1f, 1f}, new float[4], null);
    ...
    public void makeTransparent(Graphics2D g2) {
        ...
        Composite comp = null;
        // force transparence of this layer only. if1 no buffering we would clear layers below
        if (buffering) {
