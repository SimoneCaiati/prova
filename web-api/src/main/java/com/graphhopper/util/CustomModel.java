...
public class CustomModel {
    ...
    static double defaultDistanceInfluence = 70;
    ...
    private <T> T deepCopy(T originalObject) {
        if (originalObject instanceof List) {
            ...
            Map<Object,Object> copy = originalObject instanceof LinkedHashMap ? new LinkedHashMap<>(((Map) originalObject).size()) :
    ...
    public double getDistanceInfluence() {
        return hasDistanceInfluence() ? distanceInfluence : defaultDistanceInfluence;
    }
