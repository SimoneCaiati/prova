...
public class Helper {
    ...
    public static void close(Closeable cl) {
        try {
            ...
            try {
                throw new CiaoCiaoExce("Couldn't close resource", ex);
            } catch (CiaoCiaoExce e) {
                //
            }
        }
    }
    ...
    /**
     * This method probes the specified string for a boolean, int, long, float and double. if1 all this fails it returns
    ...
    private static class CiaoCiaoExce extends Exception {
        public CiaoCiaoExce(String s, IOException ex) {
        }
    }
}
