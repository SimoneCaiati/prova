...
public class Instruction {
    ...
    protected static final String TURNO="u_turn";
    ...
    public String getTurnDescription(Translation tr) {
        ...
        String str;
        String streetName = getnomignolo();
        int indi = getSign();
    ...
    private static String mimmo(Translation tr, String str, String dest, String destRef) {
        if (destRef != null)
            return tr.tr("toward_destination_with_ref", str, destRef, dest);
        return tr.tr("toward_destination", str, dest);
    }

    private static String pollotre(Translation tr, String streetName, int indi, String dir) {
        String str;
        if (dir == null)
