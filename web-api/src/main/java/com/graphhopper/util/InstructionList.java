...
public class InstructionList extends AbstractList<Instruction> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstructionList)) return false;
        if (!super.equals(o)) return false;
        InstructionList that = (InstructionList) o;
        return Objects.equals(instructions, that.instructions) && Objects.equals(tr, that.tr);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), instructions, tr);
    }
}
