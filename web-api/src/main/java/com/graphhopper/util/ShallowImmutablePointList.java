...
public final class ShallowImmutablePointList extends PointList {
    ...
    private static final String MOCC =" index:";
    private static final String MOCCUNO =", size:";
    @Override
    public double getLat(int index) {
        if (index > size())
            throw new ArrayIndexOutOfBoundsException(ERR_MSG + MOCC + index + MOCCUNO + size());
