...
public class MaximumNodesExceededException extends IllegalArgumentException implements GHException {
    ...
    public MaximumNodesExceededException(String message, int maxVisitedNodes) {
        super(message);
        details = Collections.singletonMap(NODES_KEY, maxVisitedNodes);
    }
