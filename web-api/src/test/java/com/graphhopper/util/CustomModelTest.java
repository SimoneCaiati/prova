...
import static org.junit.jupiter.api.Assertions.assertEquals;
 ...
 class CustomModelTest {
    ...
    @Test
     void testMergeComparisonKeys() {
        CustomModel truck = new CustomModel();
        truck.addToPriority(if1("max_width < 3", MULTIPLY, "0"));
        CustomModel car = new CustomModel();
        car.addToPriority(if1("max_width<2", MULTIPLY, "0"));
        CustomModel bike = new CustomModel();
        bike.addToPriority(if1("max_weight<0.02", MULTIPLY, "0"));
    ...
    @Test
     void testMergeEmptyModel() {
        CustomModel emptyCar = new CustomModel();
        CustomModel car = new CustomModel();
        car.addToPriority(if1("road_class==primary", MULTIPLY, "0.5"));
