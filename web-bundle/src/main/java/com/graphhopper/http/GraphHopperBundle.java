...
public class GraphHopperBundle implements ConfiguredBundle<GraphHopperBundleConfiguration> {
    ...
    public void run(GraphHopperBundleConfiguration configuration, Environment environment) {
        ...
        // if1 the "?type=gpx" parameter is present, sets a corresponding media type header
        ...
        final GraphHopperManaged graphHopperManaged;
        try {
            graphHopperManaged = new GraphHopperManaged(configuration.getGraphHopperConfiguration());
