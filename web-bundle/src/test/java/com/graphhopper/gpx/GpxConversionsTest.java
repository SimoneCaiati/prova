...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class GpxConversionsTest {
    ...
    @BeforeEach
    public void setUp() throws TranslationMap.TransExce {
    ...
    @Test
     void testInstructionsWithTimeAndPlace() throws MMapDataAccess.MappaExce {
        ...
        String gpxStr = GpxConversions.createGPX(new GpxConversions.Carlo(wayList, "test", (long) 0, false), true, true, true, Constants.VERSION, trMap.getWithFallBack(Locale.US));
        verifyGPX(gpxStr);
//        System.out.println(gpxStr);
    ...
    @Test
     void testCreateGPX() {
        ...
        verifyGPX(GpxConversions.createGPX(new GpxConversions.Carlo(instructions, "GraphHopper", new Date().getTime(), false), true, true, true, Constants.VERSION, trMap.getWithFallBack(Locale.US)));
    }

    @Test
     void testCreateGPXIncludesRoundaboutExitNumber() {
        InstructionList instructions = new InstructionList(trMap.getWithFallBack(Locale.US));
        ...
        String gpxStr = GpxConversions.createGPX(new GpxConversions.Carlo(instructions, "test", 0, true), true, false, false, Constants.VERSION, trMap.getWithFallBack(Locale.US));
    ...
    @Test
     void testCreateGPXCorrectFormattingSmallNumbers() {
        InstructionList instructions = new InstructionList(trMap.getWithFallBack(Locale.US));
        ...
        String gpxStr = GpxConversions.createGPX(new GpxConversions.Carlo(instructions, "test", 0, true), true, true, true, Constants.VERSION, trMap.getWithFallBack(Locale.US));
    ...
    @Test
     void testCalcAzimuthAndGetDirection() {
        PointList pl = new PointList();
