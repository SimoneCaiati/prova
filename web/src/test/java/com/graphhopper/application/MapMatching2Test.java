...
public class MapMatching2Test {
    ...
    @Test
    public void testIssue13() throws IOException, MapExc, TranslationMap.TransExce {
    ...
    @Test
    public void testIssue70() throws IOException, MapExc, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper();
        ...
        try {
            hopper.importOrLoad();
        } catch (lockexception | MMapDataAccess.MapExce e) {
            e.printStackTrace();
        } catch (closefile e) {
           e.printStackTrace();
        }
    ...
    @Test
    public void testIssue127() throws IOException, MapExc, TranslationMap.TransExce {
        GraphHopper hopper = new GraphHopper();
        hopper.setOSMFile("../map-matching/files/map-issue13.osm.gz");
        hopper.setGraphHopperLocation(GH_LOCATION);
        hopper.setProfiles(new Profile("my_profile").setVehicle("car").setWeighting("fastest"));
