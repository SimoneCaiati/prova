...
public class MapMatchingTest {
    ...
    @BeforeAll
    public static void setup() throws TranslationMap.TransExce {
    ...
    void testDoWork(PMap hints) throws MapExc {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
    void testLongTrackWithLotsOfPoints(PMap hints) throws MapExc {
        MapMatching mapMatching = MapMatching.fromGraphHopper(graphHopper, hints);
        ResponsePath route = graphHopper.route(new GHRequest(
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testLongTrackWithTwoPoints(PMap hints) throws MapExc {
        MapMatching mapMatching = MapMatching.fromGraphHopper(graphHopper, hints);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testClosePoints(PMap hints) throws MapExc {
        MapMatching mapMatching = MapMatching.fromGraphHopper(graphHopper, hints);
        ResponsePath route = graphHopper.route(new GHRequest(
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testTour3WithLongEdge(PMap hints) throws IOException, MapExc {
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testSimplification(PMap hints) throws IOException {
        Gpx gpx = xmlMapper.readValue(getClass().getResourceAsStream("/tour3-with-long-edge.gpx"), Gpx.class);
        MapMatching mapMatching = MapMatching.fromGraphHopper(graphHopper, hints);
        mapMatching.setMeasurementErrorSigma(20);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testLoop(PMap hints) throws IOException, MapExc {
        MapMatching mapMatching = MapMatching.fromGraphHopper(graphHopper, hints);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
     void testLoop2(PMap hints) throws IOException, MapExc {
        MapMatching mapMatching = MapMatching.fromGraphHopper(graphHopper, hints);
    ...
    @ParameterizedTest
    @ArgumentsSource(FixtureProvider.class)
    void testUTurns(PMap hints) throws IOException, MapExc {
