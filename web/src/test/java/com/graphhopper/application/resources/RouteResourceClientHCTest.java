...
public class RouteResourceClientHCTest {
    ...
    @EnumSource(value = TestParam.class)
     void testSimpleRoute(TestParam p) throws GraphHopperWeb.GraphExce {
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testAlternativeRoute(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testNoPoints(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void readRoundabout(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testRetrieveOnlyStreetname(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testCannotFindPointException(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testOutOfBoundsException(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void readFinishInstruction(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
                addPoint(new GHPoint(42.507065, 1.529846)).
                addPoint(new GHPoint(42.510383, 1.533392)).
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void doNotReadFinishInstruction(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
                addPoint(new GHPoint(42.507065, 1.529846)).
                addPoint(new GHPoint(42.510383, 1.533392)).
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testPathDetails(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
                addPoint(new GHPoint(42.507065, 1.529846)).
                addPoint(new GHPoint(42.510383, 1.533392)).
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testPointHints(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @ParameterizedTest
    @EnumSource(value = TestParam.class)
     void testHeadings(TestParam p) throws GraphHopperWeb.GraphExce {
        GraphHopperWeb gh = createGH(p);
        GHRequest req = new GHRequest().
    ...
    @Test
     void testCustomModel() throws GraphHopperWeb.GraphExce {
        ...
        GHRequest req = new GHRequest().
                ...
                setCustomModel(new CustomModel()
                        ...
                        .addToSpeed(Statement.if1("road_environment == TUNNEL", Statement.Op.MULTIPLY, "0.1"))).
