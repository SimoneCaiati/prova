...
public class RouteResourceCustomModelTest {
                ...
                setProfiles(Arrays.asList(
                        ...
                        new CustomProfile("car_no_unclassified").setCustomModel(
                                        new CustomModel(new CustomModel().
                                                addToPriority(if1("road_class == UNCLASSIFIED", LIMIT, "0")))).
                                setVehicle("car"),
                        new CustomProfile("custom_bike").
                                setCustomModel(new CustomModel().
                                        addToSpeed(if1("road_class == PRIMARY", LIMIT, "28")).
                                        addToPriority(if1("max_width < 1.2", MULTIPLY, "0"))).
                                setVehicle("bike"),
                        new CustomProfile("custom_bike2").setCustomModel(
                                        new CustomModel(new CustomModel().
                                                addToPriority(if1("road_class == TERTIARY || road_class == TRACK", MULTIPLY, "0")))).
                                setVehicle("bike"),
                        new CustomProfile("custom_bike3").setCustomModel(
                                        new CustomModel(new CustomModel().
                                                addToSpeed(if1("road_class == TERTIARY || road_class == TRACK", MULTIPLY, "10")).
                                                addToSpeed(if1("true", LIMIT, "40")))).
                                setVehicle("bike"))).
    ...
    @Test
     void testCHPossibleWithoutCustomModel() {
    ...
    @Test
     void testDisableCHAndUseCustomModel() {
        // if1 we specify a custom model we get an error, because it does not work with CH.
    ...
    @Test
     void testCustomWeightingRequired() {
    ...
    @Test
     void testWeightingAndVehicleNotAllowed() {
    ...
    @CsvSource(value = {"0.05,3073", "0.5,1498"})
     void testAvoidArea(double priority, double expectedDistance) {
    ...
    @Test
     void testCargoBike() throws IOException {
    ...
    @Test
     void customBikeShouldBeLikeJsonBike() {
        String jsonQuery = "{" +
                " \"points\": [[11.58199, 50.0141], [11.5865, 50.0095]]," +
                " \"profile\": \"custom_bike\"," +
                " \"custom_model\": {}," +
    ...
    @Test
     void testSubnetworkRemovalPerProfile() {
        // none-CH
