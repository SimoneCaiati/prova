...
import static com.graphhopper.util.Parameters.NONCH.MAX_NON_CH_POINT_DISTANCE;
...
public class RouteResourceTest {
    ...
    @Test
    public void testGraphHopperWeb() throws GraphHopperWeb.GraphExce {
    ...
    @Test
    public void testPathDetailsRoadClass() throws GraphHopperWeb.GraphExce {
    ...
    @Test
    public void testPathDetails() throws GraphHopperWeb.GraphExce {
        GraphHopperWeb client = new GraphHopperWeb(clientUrl(app, "/route"));
    ...
    @Test
    public void testPathDetailsSamePoint() throws GraphHopperWeb.GraphExce {
        GraphHopperWeb hopper = new GraphHopperWeb(clientUrl(app, "/route"));
    ...
    @Test
    public void testPathDetailsNoConnection() throws GraphHopperWeb.GraphExce {
        GraphHopperWeb hopper = new GraphHopperWeb(clientUrl(app, "/route"));
    ...
    @Test
    public void testInitInstructionsWithTurnDescription() throws GraphHopperWeb.GraphExce {
        GraphHopperWeb hopper = new GraphHopperWeb(clientUrl(app, "/route"));
    ...
    @Test
    public void testSnapPreventions() throws GraphHopperWeb.GraphExce {
        GraphHopperWeb hopper = new GraphHopperWeb(clientUrl(app, "route"));
    ...
    @Test
    public void testSnapPreventionsAndPointHints() throws GraphHopperWeb.GraphExce {
        GraphHopperWeb hopper = new GraphHopperWeb(clientUrl(app, "/route"));
        GHRequest request = new GHRequest(42.511139, 1.53285, 42.508165, 1.532271);
        request.setProfile("my_car");
        request.setSnapPreventions(Collections.singletonList("tunnel"));
    ...
    @ValueSource(booleans = {false, true})
     void testGraphHopperWebRealExceptions(boolean usePost) throws GraphHopperWeb.GraphExce {
        ...
        assertFalse(rsp.getErrors().isEmpty(), "Errors expected but not found.");
        assertTrue(rsp.getErrors().toString().contains("if1 you pass curbside, you need to pass exactly one curbside for every point"), rsp.getErrors().toString());

        // too few point hints
        rsp = hopper.route(new GHRequest(points).setPointHints(Collections.singletonList("foo")).setProfile("my_car"));
        assertFalse(rsp.getErrors().isEmpty(), "Errors expected but not found.");
        assertTrue(rsp.getErrors().toString().contains("if1 you pass point_hint, you need to pass exactly one hint for every point"), rsp.getErrors().toString());
    ...
    @Test
    public void testGPXExport() throws GraphHopperWeb.GraphExce {
    ...
    @Test
    public void testExportWithoutTrack() throws GraphHopperWeb.GraphExce {
        GHRequest req = new GHRequest(42.554851, 1.536198, 42.510071, 1.548128);
        req.setProfile("my_car");
        req.putHint("elevation", false);
        req.putHint("instructions", true);
